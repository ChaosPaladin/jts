...
public class guardcap_of_maze extends warrior_use_skill {
...
if (gg.HaveMemo(target, 691) == 1 && gg.GetMemoState(target, 691) == 1) {
...
case 0: {
myself.SetCurrentQuestID(691);
target = code_info.RandomSelectOne();
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
i0 = gg.Rand(1000);
if (i0 <= 129) {
myself.GiveItem1(target, 10372, 3);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else {
myself.GiveItem1(target, 10372, 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");
