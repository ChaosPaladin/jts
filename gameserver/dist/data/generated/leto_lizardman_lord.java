...
if (gg.HaveMemo(c1, 226) && gg.GetMemoState(c1, 226) == 8 && gg.OwnItemCount(c1, 2816) && gg.OwnItemCount(c1, 2819) == 0) {
if (myself.GetCurrentTick() - c1.quest_last_reward_time > 1) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2819, 1);
myself.SoundEffect(c1, "Itemsound.quest_middle");
myself.SetFlagJournal(c1, 226, 19);
...
myself.SetCurrentQuestID(226);
myself.AddTimerEx(22606, 1000 * 200);
super;
	}
