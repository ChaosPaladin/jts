...
public class ai_boss08_evilate_a extends default_npc {
	protected String Privates = "portrait_spirit:ai_boss08_portrait_spirit:4:20sec";
...
if (timer_id == 1000) {
myself.CreateOnePrivateInzoneEx(1029050, "ai_boss08_portrait_spirit", 0, 0, SpawnPosX, SpawnPosY, SpawnPosZ, SpawnAngle, 0, 0, 0, myself.InstantZone_GetId());
myself.AddTimerEx(1001, 20000);

} else if (timer_id == 1001) {
myself.CreateOnePrivateInzoneEx(1029050, "ai_boss08_portrait_spirit", 0, 0, SpawnPosX, SpawnPosY, SpawnPosZ, SpawnAngle, 0, 0, 0, myself.InstantZone_GetId());
myself.AddTimerEx(1002, 20000);

} else if (timer_id == 1002) {
myself.CreateOnePrivateInzoneEx(1029050, "ai_boss08_portrait_spirit", 0, 0, SpawnPosX, SpawnPosY, SpawnPosZ, SpawnAngle, 0, 0, 0, myself.InstantZone_GetId());
myself.AddTimerEx(1003, 20000);
