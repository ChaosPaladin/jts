...
public class baium extends ai_boss06_baium {
...
if (gg.HaveMemo(attacker, 234)) {
if (attacker.equiped_weapon_class_id == 4665) {
myself.DeleteItem1(attacker, 4665, 1);
myself.GiveItem1(attacker, 4673, 1);
myself.SoundEffect(attacker, "ItemSound.quest_itemget");
myself.Say(gg.MakeFString(23434, "", "", "", "", ""));
