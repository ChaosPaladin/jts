...
} else if (gg.HaveMemo(c1, 233) && gg.OwnItemCount(c1, 2880) == 1 && gg.OwnItemCount(c1, 2881) >= 13) {
myself.SetFlagJournal(c1, 233, 4);
myself.ShowQuestMark(c1, 233);
...
if (gg.HaveMemo(c1, 222) && gg.OwnItemCount(c1, 2767) > 0 && gg.OwnItemCount(c1, 2776) < 10 && gg.GetMemoState(c1, 222) == 1) {
i0 = gg.GetMemoStateEx(c1, 222, 1);
myself.SetMemoStateEx(c1, 222, 1, i0 + 1);
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2776, 1);
if (gg.OwnItemCount(c1, 2776) >= 10) {
myself.SoundEffect(c1, "ItemSound.quest_middle");
if (i0 >= 9) {
