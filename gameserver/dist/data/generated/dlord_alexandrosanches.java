...
myself.Say(gg.MakeFString(33414, "", "", "", "", ""));
if (gg.Rand(2) == 0) {
if (myself.GetCurrentTick() - c1.quest_last_reward_time > 1) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.CreateOnePrivate(1027154, "abyssking_bonaparterius", 0, 1);
...
myself.SetCurrentQuestID(334);
myself.AddTimerEx(2336004, 1000 * 200);
myself.Say(gg.MakeFString(33424, "", "", "", "", ""));
super;
	}
