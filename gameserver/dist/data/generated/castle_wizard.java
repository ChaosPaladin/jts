...
public class castle_wizard extends citizen {
...
myself.ShowPage(talker, "court_magician001.htm");

} else {
myself.ShowPage(talker, "court_magician002.htm");
...
if (ask == -301) {
if (reply == 1) {
myself.ShowMultisell(606, talker);
...
myself.ShowPage(talker, fnHi4);
	...
	protected void TELEPORT_REQUESTED(HandlerParam talker, HandlerParam c0) {
if (myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
c0 = myself.Pledge_GetLeader(talker);
if (myself.IsNullCreature(c0) == 0 && c0.hp > 0) {
if (gg.GetAbnormalLevel(c0, myself.Skill_GetAbnormalType(238026753)) > 0) {
myself.AddUseSkillDesire(talker, 334823425, 1, 0, 1000000);
myself.TeleportToUser(talker, c0);

} else {
gg.AddLog(10, talker, 1);
myself.ShowPage(talker, "court_magician003.htm");

}

} else {
gg.AddLog(10, talker, 3);
myself.ShowPage(talker, "court_magician003.htm");
	...
	protected void TELEPORT_TO_USER_RES(HandlerParam talker, HandlerParam i0, HandlerParam success, HandlerParam c0) {
if (success == 0) {
gg.AddLog(10, talker, success);
