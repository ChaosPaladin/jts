...
public class fallenangel_haures_2 extends lv3_healer {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 85) == 1 && target.occupation == 16 && gg.GetMemoState(target, 85) == 7 && gg.OwnItemCount(target, 7345) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8552, "", "", "", "", ""));
myself.GiveItem1(target, 7345, 1);
myself.SetFlagJournal(target, 85, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8550, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8551, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
