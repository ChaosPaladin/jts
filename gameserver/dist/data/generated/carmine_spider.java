...
target = last_attacker;
if (gg.HaveMemo(target, 283) == 1 && gg.GetMemoState(target, 283) == 1 * 10 + 1) {
...
if (gg.HaveMemo(c1, 419) == 1 && gg.OwnItemCount(c1, 10164) == 1) {
if (gg.OwnItemCount(c1, 10165) < 50 && gg.Rand(100) < 75) {
myself.GiveItem1(c1, 10165, 1);
if (gg.OwnItemCount(c1, 10165) >= 50) {
...
switch (code_info.code) {
case 1: {
myself.SetCurrentQuestID(283);
target = code_info.RandomSelectOne();
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
i4 = gg.Rand(1000);
if (i4 < 600) {
myself.GiveItem1(target, 9747, 1);
