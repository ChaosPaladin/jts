...
public class angel_iconoclasis_3 extends lv3_dwarf {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 100) == 1 && target.occupation == 57 && gg.GetMemoState(target, 100) == 7 && gg.OwnItemCount(target, 7360) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(10052, "", "", "", "", ""));
myself.GiveItem1(target, 7360, 1);
myself.SetFlagJournal(target, 100, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(10050, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(10051, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
