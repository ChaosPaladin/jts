...
public class jurek extends master_lv3_hew {
	protected void TALK_SELECTED(HandlerParam fhtml0, HandlerParam talker) {
if (_from_choice == 0) {
if (gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2676) == 1 && gg.OwnItemCount(talker, 2690) == 0 && gg.OwnItemCount(talker, 2698) == 0) {
_choiceN = _choiceN + 1;
_code = 0;
myself.AddChoice(0, "Trial of the Scholar (In Progress)");

}
if (gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2676) == 1 && gg.OwnItemCount(talker, 2694) == 1) {
_choiceN = _choiceN + 1;
_code = 1;
myself.AddChoice(1, "Trial of the Scholar (In Progress)");

}
if (gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2676) >= 1 && gg.OwnItemCount(talker, 2698) >= 1 && gg.OwnItemCount(talker, 2690) == 0) {
_choiceN = _choiceN + 1;
_code = 2;
myself.AddChoice(2, "Trial of the Scholar (In Progress)");

}
if (gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2675) >= 1 || gg.OwnItemCount(talker, 2677) >= 1) {
_choiceN = _choiceN + 1;
_code = 3;
...
_choiceN = _choiceN + 1;
_code = 4;
myself.AddChoice(4, "Enhance Your Weapon");

}
if (gg.HaveMemo(talker, 350) == 0 && talker.level >= 40) {
_choiceN = _choiceN + 1;
_code = 5;
myself.AddChoice(5, "Enhance Your Weapon");

}
if (gg.HaveMemo(talker, 350) == 1 && gg.GetMemoState(talker, 350) == 1) {
_choiceN = _choiceN + 1;
_code = 6;
myself.AddChoice(6, "Enhance Your Weapon (In Progress)");

}
if (gg.HaveMemo(talker, 350) == 1 && gg.GetMemoState(talker, 350) != 1) {
_choiceN = _choiceN + 1;
_code = 7;
myself.AddChoice(7, "Enhance Your Weapon (In Progress)");
...
switch (_code) {
case 0: {
if (_from_choice == 0 || gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2676) == 1 && gg.OwnItemCount(talker, 2690) == 0 && gg.OwnItemCount(talker, 2698) == 0) {
...
myself.ShowPage(talker, "jurek_q0214_01.htm");
...
case 1: {
if (_from_choice == 0 || gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2676) == 1 && gg.OwnItemCount(talker, 2694) == 1) {
myself.SetCurrentQuestID(214);
if (myself.GetInventoryInfo(talker, 0) >= myself.GetInventoryInfo(talker, 1) * 0.800000 || myself.GetInventoryInfo(talker, 2) >= myself.GetInventoryInfo(talker, 3) * 0.800000) {
myself.ShowSystemMessage(talker, 1118);
return;
...
if (gg.OwnItemCount(talker, 2695) + gg.OwnItemCount(talker, 2696) + gg.OwnItemCount(talker, 2697) < 12) {
myself.ShowPage(talker, "jurek_q0214_04.htm");

} else if (gg.OwnItemCount(talker, 2690) >= 1) {
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.ShowPage(talker, "jurek_q0214_05.htm");
myself.SetFlagJournal(talker, 214, 18);
myself.ShowQuestMark(talker, 214);
myself.SoundEffect(talker, "ItemSound.quest_middle");
myself.DeleteItem1(talker, 2694, gg.OwnItemCount(talker, 2694));
myself.DeleteItem1(talker, 2695, gg.OwnItemCount(talker, 2695));
myself.DeleteItem1(talker, 2696, gg.OwnItemCount(talker, 2696));
myself.DeleteItem1(talker, 2697, gg.OwnItemCount(talker, 2697));
myself.DeleteItem1(talker, 2690, 1);
myself.GiveItem1(talker, 2698, 1);
...
case 2: {
if (_from_choice == 0 || gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2676) >= 1 && gg.OwnItemCount(talker, 2698) >= 1 && gg.OwnItemCount(talker, 2690) == 0) {
myself.SetCurrentQuestID(214);
if (myself.GetInventoryInfo(talker, 0) >= myself.GetInventoryInfo(talker, 1) * 0.800000 || myself.GetInventoryInfo(talker, 2) >= myself.GetInventoryInfo(talker, 3) * 0.800000) {
myself.ShowSystemMessage(talker, 1118);
return;
...
myself.ShowPage(talker, "jurek_q0214_06.htm");
...
case 3: {
if (_from_choice == 0 || gg.HaveMemo(talker, 214) == 1 && gg.OwnItemCount(talker, 2675) >= 1 || gg.OwnItemCount(talker, 2677) >= 1) {
myself.SetCurrentQuestID(214);
if (myself.GetInventoryInfo(talker, 0) >= myself.GetInventoryInfo(talker, 1) * 0.800000 || myself.GetInventoryInfo(talker, 2) >= myself.GetInventoryInfo(talker, 3) * 0.800000) {
myself.ShowSystemMessage(talker, 1118);
return;
...
myself.ShowPage(talker, "jurek_q0214_07.htm");
...
myself.ShowQuestPage(talker, "jurek_q0350_01.htm", 350);
...
if (myself.GetMemoCount(talker) < 41) {
myself.FHTML_SetFileName(fhtml0, "jurek_q0350_02.htm");
...
myself.ShowPage(talker, "jurek_q0350_03.htm");
...
myself.ShowPage(talker, "jurek_q0350_11a.htm");
...
myself.ShowPage(talker, "jurek_q0350_11.htm");
...
myself.ShowPage(talker, "jurek_q0350_13.htm");
...
myself.ShowQuestPage(talker, "jurek_q0350_03.htm", 350);
...
if (ask == 214) {
if (reply == 1) {
myself.ShowPage(talker, "jurek_q0214_02.htm");

}
if (reply == 2) {
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.ShowPage(talker, "jurek_q0214_03.htm");
myself.SetFlagJournal(talker, 214, 16);
myself.ShowQuestMark(talker, 214);
myself.SoundEffect(talker, "ItemSound.quest_middle");
myself.GiveItem1(talker, 2694, 1);
myself.GiveItem1(talker, 2690, 1);
...
if (ask == 350) {
if (reply == 1) {
myself.ShowPage(talker, "jurek_q0350_05.htm");

}
if (reply == 2) {
myself.ShowPage(talker, "jurek_q0350_06.htm");

}
if (reply == 3) {
myself.ShowPage(talker, "jurek_q0350_07.htm");
...
myself.ShowPage(talker, "jurek_q0350_08.htm");
...
myself.SetMemoState(talker, 350, 2);
myself.ShowPage(talker, "jurek_q0350_09.htm");
...
myself.SetMemoState(talker, 350, 2);
myself.ShowPage(talker, "jurek_q0350_10.htm");
...
myself.ShowPage(talker, "jurek_q0350_14.htm");

}
if (reply == 8) {
myself.ShowPage(talker, "jurek_q0350_06a.htm");
