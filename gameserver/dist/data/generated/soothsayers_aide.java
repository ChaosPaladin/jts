...
target = last_attacker;
if (gg.HaveMemo(target, 611) == 1 && gg.OwnItemCount(target, 7222) >= 1 && gg.OwnItemCount(target, 7228) < 100 || gg.OwnItemCount(target, 7223) >= 1 && gg.OwnItemCount(target, 7228) < 200 || gg.OwnItemCount(target, 7224) >= 1 && gg.OwnItemCount(target, 7228) < 200) {
...
i4 = gg.Rand(1000);
if (i4 < 626) {
myself.GiveItem1(target, 7228, 1);
...
myself.AddUseSkillDesire(attacker, 297992193, 0, 1, 1000000);
