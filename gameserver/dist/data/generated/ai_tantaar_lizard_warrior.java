...
public class ai_tantaar_lizard_warrior extends warrior_basic {
	protected int Skill01_Check_Dist = 1;
	protected int Skill01_Dist_Max = 200;
...
myself.MakeAttackEvent(myself.c_ai0, 10000, 0);
...
super;
if (myself.sm.npc_class_id == 1022768) {
