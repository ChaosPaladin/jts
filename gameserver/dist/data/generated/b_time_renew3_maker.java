...
public class b_time_renew3_maker extends inzone_maker {
...
super;
	...
	protected void ON_SCRIPT_EVENT(HandlerParam script_event_arg1, HandlerParam script_event_arg2, HandlerParam script_event_arg3, HandlerParam i0, HandlerParam i1, HandlerParam i2, HandlerParam def0) {
if (script_event_arg1 == 12544) {
myself.i_ai0 = script_event_arg2 - 1;

} else if (script_event_arg1 == 12545) {
...
if (myself.i_ai0 != i0 && myself.i_ai1 != i0) {
...
def0 = myself.GetSpawnDefine(i0);
if (gg.IsNull(def0) == 0) {
def0.SendScriptEvent(12543, 3, 0);
