...
public class ranku extends raid_lanekoo {
...
target = last_attacker;
if (gg.HaveMemo(target, 132) == 1 && myself.GetOneTimeQuestFlag(target, 132) == 0 && gg.GetMemoState(target, 132) == 1 && gg.OwnItemCount(target, 9800) == 0) {
...
myself.SetCurrentQuestID(132);
if (gg.OwnItemCount(target, 9801) == 0) {
myself.GiveItem1(target, 9800, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else if (gg.OwnItemCount(target, 9801) >= 1) {
myself.GiveItem1(target, 9800, 1);
