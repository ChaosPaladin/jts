...
public class rift_watcher_3 extends teleport_dungeon_admit_npc {
...
} else if (gg.OwnItemCount(c1, 7079) < 27) {
i5 = gg.GetMemoStateEx(c1, 635, 1);
if (gg.GetMemoState(c1, 635) != 1 || i6 - i5 > 3600) {
i1 = 1;
