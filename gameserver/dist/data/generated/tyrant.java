...
if (gg.HaveMemo(c1, 334) && gg.OwnItemCount(c1, 3680) && gg.OwnItemCount(c1, 3681) && gg.OwnItemCount(c1, 3690) == 0) {
if (gg.Rand(10) == 0) {
if (myself.GetCurrentTick() - c1.quest_last_reward_time > 1) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 3690, 1);
if (gg.OwnItemCount(c1, 3684) >= 1 && gg.OwnItemCount(c1, 3685) >= 1 && gg.OwnItemCount(c1, 3686) >= 1 && gg.OwnItemCount(c1, 3687) >= 1 && gg.OwnItemCount(c1, 3688) >= 1 && gg.OwnItemCount(c1, 3689) >= 1 && gg.OwnItemCount(c1, 3689) >= 1 && gg.OwnItemCount(c1, 3691) >= 1) {
