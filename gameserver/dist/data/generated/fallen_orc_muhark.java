...
public class fallen_orc_muhark extends lv3_ranger {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 75) == 1 && target.occupation == 46 && gg.GetMemoState(target, 75) == 7 && gg.OwnItemCount(target, 7335) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(7552, "", "", "", "", ""));
myself.GiveItem1(target, 7335, 1);
myself.SetFlagJournal(target, 75, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(7550, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(7551, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
