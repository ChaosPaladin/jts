...
if (gg.GetMemoState(c1, 211) == 8) {
myself.SetMemoState(c1, 211, 9);
myself.SoundEffect(c1, "ItemSound.quest_middle");
myself.SetFlagJournal(c1, 211, 10);
myself.ShowQuestMark(c1, 211);

}
if (myself.Maker_GetNpcCount() < 10) {
myself.CreateOnePrivateEx(1030646, "raldo", 0, 0, gg.FloatToInt(myself.sm.x), gg.FloatToInt(myself.sm.y), gg.FloatToInt(myself.sm.z), 0, 0, 0, 0);
