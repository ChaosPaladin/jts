...
public class dawn_acolyte3 extends ssq_main_event_acolyte {
...
if (gg.AddPartyToEventRoom(3, 2, party0.id)) {
...
gg.AddPartyToEventRoom(3, 2, party0.id);
...
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_20h.htm");
...
} else if (gg.StrToInt(gg.GetTimeAttackRecordInfo(3, 2, 4, 0)) > gg.OwnItemCount(talker, 5901)) {
i1 = gg.Party_GetCount(talker);
for (i0 = 0; i0 < i1; i0 = i0 + 1) {
c1 = gg.Party_GetCreature(talker, i0);
...
myself.RemoveMemo(talker, 505);
myself.AddTimeAttackRecord(3, 2, party0.id, gg.OwnItemCount(talker, 5901), gg.GetTimeOfDay(), gg.GetMemoState(talker, 505));
