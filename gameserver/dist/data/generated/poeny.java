...
public class poeny extends citizen {
...
_choiceN = _choiceN + 1;
_code = 3;
myself.AddChoice(3, "Dark Elf's Tutorial");

}
if (gg.GetMemoStateEx(talker, 255, 1) > 3) {
_choiceN = _choiceN + 1;
_code = 4;
myself.AddChoice(4, "Dark Elf's Tutorial");
...
if (talker.race == 2) {
myself.DeleteRadar(talker, 28384, 11056, -4233, 2);
...
if (myself.IsInCategory(0, talker.occupation)) {
myself.ShowPage(talker, "poeny003f.htm");

} else {
myself.ShowPage(talker, "poeny003m.htm");

}
myself.DeleteItem1(talker, 6353, gg.OwnItemCount(talker, 6353));
myself.SetMemoStateEx(talker, 255, 1, 3);
myself.GiveItem1(talker, 1070, 1);
myself.AddTimerEx(gg.GetIndexFromCreature(talker) + 1000000, 1000 * 30);
...
myself.ShowPage(talker, "poeny004.htm");
...
myself.VoiceEffect(talker, "tutorial_voice_010d", 0);
