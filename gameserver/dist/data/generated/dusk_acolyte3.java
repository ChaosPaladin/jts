...
public class dusk_acolyte3 extends ssq_main_event_acolyte {
...
myself.FHTML_SetFileName(fhtml0, "ssq_main_event_acolyte_q0505_04c.htm");
myself.FHTML_SetStr(fhtml0, "name", c1.name);
myself.ShowFHTML(talker, fhtml0);
myself.RemoveMemo(talker, 505);
return;

} else if (c1.max_magic_level > 53) {
...
if (gg.GetMemoStateEx(talker, 505, 1) == 3000) {
if (gg.OwnItemCount(talker, 6360) < 3000) {
...
if (gg.OwnItemCount(talker, 6361) < 1800) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_21b.htm");
return;
...
if (gg.OwnItemCount(talker, 6362) < 900) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_21b.htm");
return;
...
if (gg.AddPartyToEventRoom(3, 1, party0.id)) {
...
myself.DeleteItem1(talker, 6360, 3000);
...
myself.DeleteItem1(talker, 6361, 1800);
...
myself.DeleteItem1(talker, 6362, 900);
...
myself.SetMemoStateEx(talker, 505, 1, 3);
gg.AddPartyToEventRoom(3, 1, party0.id);
...
myself.AddTimeAttackFee(3, 9000, party0.id);
...
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_20c.htm");
...
} else if (gg.GetMemoStateEx(talker, 505, 1) != 3) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_28.htm");

} else if (gg.StrToInt(gg.GetTimeAttackRecordInfo(3, 1, 4, 0)) > gg.OwnItemCount(talker, 5901)) {
i1 = gg.Party_GetCount(talker);
for (i0 = 0; i0 < i1; i0 = i0 + 1) {
c1 = gg.Party_GetCreature(talker, i0);
...
myself.Shout(gg.MakeFString(50503, talker.name, gg.IntToStr(54), gg.IntToStr(i2), "", ""));
...
myself.AddTimeAttackRecord(3, 1, party0.id, gg.OwnItemCount(talker, 5901), gg.GetTimeOfDay(), gg.GetMemoState(talker, 505));
...
if (gg.IsWinnerOfTimeAttackEvent(talker, 3) == 0) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_17.htm");
return;

}
if (gg.GetTimeAttackRewardFlag(talker, 3)) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_19.htm");
return;

}
i0 = gg.StrToInt(gg.GetTimeAttackRecordInfo(3, gg.GetSSQPart(talker), 2, 0));
i1 = myself.GetTimeAttackFee(3) / i0;
myself.GiveTimeAttackReward(talker, 3, 5575, i1);
...
myself.SetMemoStateEx(talker, 505, 1, 3000);
