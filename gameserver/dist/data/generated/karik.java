...
if (gg.Rand(100) < 25 && gg.OwnItemCount(c2, 5888) < 100) {
if (gg.OwnItemCount(c2, 5888) == 99) {
myself.GiveItem1(c2, 5888, 1);
myself.SoundEffect(c2, "ItemSound.quest_middle");

} else {
myself.GiveItem1(c2, 5888, 2);
myself.SoundEffect(c2, "ItemSound.quest_itemget");

}

} else if (gg.OwnItemCount(c2, 5888) < 100) {
if (gg.OwnItemCount(c2, 5888) == 99) {
myself.GiveItem1(c2, 5888, 1);
myself.SoundEffect(c2, "ItemSound.quest_middle");
