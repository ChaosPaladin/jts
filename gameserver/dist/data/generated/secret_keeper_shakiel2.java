...
public class secret_keeper_shakiel2 extends lv3_summoner {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 92) == 1 && target.occupation == 28 && gg.GetMemoState(target, 92) == 7 && gg.OwnItemCount(target, 7352) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9252, "", "", "", "", ""));
myself.GiveItem1(target, 7352, 1);
myself.SetFlagJournal(target, 92, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9250, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9251, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
