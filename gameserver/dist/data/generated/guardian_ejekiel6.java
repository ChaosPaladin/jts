...
public class guardian_ejekiel6 extends lv3_dagger {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 81) == 1 && target.occupation == 36 && gg.GetMemoState(target, 81) == 7 && gg.OwnItemCount(target, 7341) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8152, "", "", "", "", ""));
myself.GiveItem1(target, 7341, 1);
myself.SetFlagJournal(target, 81, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8150, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8151, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
