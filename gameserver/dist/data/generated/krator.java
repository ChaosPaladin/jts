...
public class krator extends cruma_warrior_use_skill {
...
if (gg.HaveMemo(c1, 222) && gg.OwnItemCount(c1, 2778) > 0 && gg.OwnItemCount(c1, 2780) < 3 && gg.GetMemoState(c1, 222) == 2) {
i0 = gg.GetMemoStateEx(c1, 222, 1);
myself.SetMemoStateEx(c1, 222, 1, i0 + 1);
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2780, 1);
if (gg.OwnItemCount(c1, 2780) >= 3) {
