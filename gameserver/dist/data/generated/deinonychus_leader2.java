...
i4 = gg.Rand(1000);
if (i4 < 319 && gg.OwnItemCount(target, 8780) <= 1) {
if (gg.OwnItemCount(target, 8780) < 1) {
myself.GiveItem1(target, 8780, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else if (gg.OwnItemCount(target, 8780) >= 1) {
myself.GiveItem1(target, 8780, 1);
if (gg.OwnItemCount(target, 8779) >= 2) {
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
i4 = gg.Rand(1000);
if (i4 < 320 && gg.OwnItemCount(target, 8771) <= 9) {
if (gg.OwnItemCount(target, 8771) < 9) {
myself.GiveItem1(target, 8771, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else if (gg.OwnItemCount(target, 8771) == 9) {
myself.GiveItem1(target, 8771, 1);
if (gg.OwnItemCount(target, 8770) >= 10 && gg.OwnItemCount(target, 8772) >= 10) {
myself.SoundEffect(target, "ItemSound.quest_middle");
