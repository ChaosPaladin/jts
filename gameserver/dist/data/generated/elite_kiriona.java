...
public class elite_kiriona extends ai_elite_kiriona {
...
target = last_attacker;
if (gg.HaveMemo(target, 453) == 1 && gg.GetMemoState(target, 453) == 1 && gg.GetMemoStateEx(target, 453, 1) == 3) {
...
myself.SetCurrentQuestID(453);
myself.IncreaseNPCLogByID(target, 453, 0, 1022761, 20);
if (myself.GetNPCLogByID(target, 453, 0, 1022760) >= 20 && myself.GetNPCLogByID(target, 453, 0, 1022761) >= 20 && myself.GetNPCLogByID(target, 453, 0, 1022762) >= 20) {
