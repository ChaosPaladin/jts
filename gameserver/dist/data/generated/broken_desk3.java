...
public class broken_desk3 extends citizen {
...
myself.ShowPage(talker, "broken_desk3_q0025_01.htm");
...
myself.ShowPage(talker, "broken_desk3_q0025_02.htm");
...
myself.ShowPage(talker, "broken_desk3_q0025_06.htm");
...
i0 = i0 % 10000;
if (i0 >= 1000) {
myself.ShowPage(talker, "broken_desk3_q0025_03.htm");

} else if (gg.Rand(60) > gg.GetMemoStateEx(talker, 25, 1)) {
myself.SetMemoStateEx(talker, 25, 1, gg.GetMemoStateEx(talker, 25, 1) + 20);
myself.SetMemoState(talker, 25, gg.GetMemoState(talker, 25) + 1000);
myself.ShowPage(talker, "broken_desk3_q0025_04.htm");

} else {
myself.SetMemoState(talker, 25, 8);
myself.ShowPage(talker, "broken_desk3_q0025_05.htm");
...
myself.CreateOnePrivateEx(1027218, "triyol_zzolda", 0, 0, 50055, -47020, -3396, 0, gg.GetIndexFromCreature(talker), talker.dbid, myself.sm.id);
myself.ShowPage(talker, "broken_desk3_q0025_07.htm");
myself.SetFlagJournal(talker, 25, 7);
myself.ShowQuestMark(talker, 25);

} else if (myself.i_quest1 == talker.dbid) {
myself.ShowPage(talker, "broken_desk3_q0025_08.htm");

} else {
myself.ShowPage(talker, "broken_desk3_q0025_09.htm");

}

}
if (gg.GetMemoState(talker, 25) == 8 && gg.OwnItemCount(talker, 7158) >= 1) {
myself.ShowPage(talker, "broken_desk3_q0025_10.htm");
...
myself.ShowPage(talker, "broken_desk3_q0025_11.htm");
