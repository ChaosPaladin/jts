...
if (gg.HaveMemo(c1, 215) && gg.GetMemoState(c1, 215) == 3 && gg.OwnItemCount(c1, 2725) == 0) {
if (gg.Rand(5) <= 5) {
if (myself.GetCurrentTick() - c1.quest_last_reward_time > 1) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2725, 1);
myself.SetMemoState(c1, 215, 4);
myself.SoundEffect(c1, "ItemSound.quest_middle");
myself.SetFlagJournal(c1, 215, 4);
