...
public class farm_plunderer_crazy extends ai_beastfarm_invader_event {
...
if (i0 < 486) {
i1 = gg.Rand(6) + 1;
if (i1 + gg.OwnItemCount(target, 15531) >= 300) {
myself.SetMemoState(target, 278, 2);
myself.SetFlagJournal(target, 278, 2);
myself.ShowQuestMark(target, 278);
myself.SoundEffect(target, "ItemSound.quest_middle");
myself.GiveItem1(target, 15531, 300 - gg.OwnItemCount(target, 15531));

} else {
myself.GiveItem1(target, 15531, i1);
