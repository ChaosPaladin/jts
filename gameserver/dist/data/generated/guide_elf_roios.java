...
public class guide_elf_roios extends newbie_guide {
protected Object[][] Position = {
{"Dark Elf Village";12111;16686;-4582;0;0}, {"Dwarven Village";115632;-177996;-905;0;0}, {"Talking Island Village";-84081;243227;-3723;0;0}, {"Orc Village";-45032;-113598;-192;0;0}, {"Kamael Village";-119697;44532;380;0;0}
};
...
if (ask == 255) {
if (reply == 10) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04.htm");

} else if (reply == 11) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04a.htm");

} else if (reply == 12) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04b.htm");

} else if (reply == 13) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04c.htm");

} else if (reply == 14) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04d.htm");

} else if (reply == 15) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04e.htm");

} else if (reply == 16) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04f.htm");

} else if (reply == 17) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04g.htm");

} else if (reply == 18) {
myself.ShowPage(talker, "guide_elf_roios_q0255_04h.htm");

} else if (reply == 31) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 46926, 51511, -2977, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 32) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 44995, 51706, -2803, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 33) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 45727, 51721, -2803, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 45487, 46511, -2996, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 36) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 47401, 51764, -2996, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 37) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 42971, 51372, -2996, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 45778, 46534, -2996, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 40) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 44476, 47153, -2984, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 41) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 42700, 50057, -2984, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 42) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 42766, 50037, -2984, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 43) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 44683, 46952, -2981, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 44) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 44667, 46896, -2982, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 45) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 45725, 52105, -2795, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 46) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 44823, 52414, -2795, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 47) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 45000, 52101, -2795, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 48) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 45919, 52414, -2795, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 49) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 44692, 52261, -2795, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 50) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 47780, 49568, -2983, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 51) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 47912, 50170, -2983, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 52) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 47868, 50167, -2983, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 53) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 28928, 74248, -3773, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 54) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 43673, 49683, -3046, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 55) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 45610, 49008, -3059, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 56) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 50592, 54986, -3376, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 46475, 50495, -3058, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 51210, 82474, -3283, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");

} else if (reply == 61) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 49262, 53607, -3216, 2);
myself.ShowPage(talker, "guide_elf_roios_q0255_05.htm");
