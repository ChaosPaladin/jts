...
if (gg.HaveMemo(c1, 401) == 1 && gg.OwnItemCount(c1, 1140) < 10 && gg.OwnItemCount(c1, 1139)) {
if (gg.Rand(10) < 4) {
myself.GiveItem1(c1, 1140, 1);
if (gg.OwnItemCount(c1, 1140) >= 9) {
myself.SoundEffect(c1, "ItemSound.quest_middle");
myself.SetFlagJournal(c1, 401, 3);
myself.ShowQuestMark(c1, 401);
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
c1 = myself.GetLastAttacker();
if (gg.HaveMemo(myself.c_quest2, 403) && gg.OwnItemCount(myself.c_quest2, 1183) < 10 && myself.i_quest2 == 1 && gg.Rand(10) < 3) {
