...
public class guide_human_cnacelot extends newbie_guide {
protected Object[][] Position = {
{"Dark Elf Village";12111;16686;-4582;0;0}, {"Dwarven Village";115632;-177996;-905;0;0}, {"Elven Village";45475;48359;-3060;0;0}, {"Orc Village";-45032;-113598;-192;0;0}, {"Kamael Village";-119697;44532;380;0;0}
};
...
if (ask == 255) {
if (reply == 10) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04.htm");

} else if (reply == 11) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04a.htm");

} else if (reply == 12) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04b.htm");

} else if (reply == 13) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04c.htm");

} else if (reply == 14) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04d.htm");

} else if (reply == 15) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04e.htm");

} else if (reply == 16) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04f.htm");

} else if (reply == 17) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04g.htm");

} else if (reply == 18) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04h.htm");

} else if (reply == 19) {
myself.ShowPage(talker, "guide_human_cnacelot_q0255_04i.htm");

} else if (reply == 31) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -84108, 244604, -3729, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -82515, 241221, -3728, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 34) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -82319, 244709, -3727, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 35) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -82659, 244992, -3717, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 36) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -86114, 244682, -3727, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 37) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -86328, 244448, -3724, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 38) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -86322, 241215, -3727, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 39) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -85964, 240947, -3727, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 40) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -85026, 242689, -3729, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 41) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -83789, 240799, -3717, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 42) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -84204, 240403, -3717, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 43) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -86385, 243267, -3717, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 44) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -86733, 242918, -3717, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 45) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -84516, 245449, -3714, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 46) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -84729, 245001, -3726, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 47) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -84965, 245222, -3726, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -85186, 245001, -3726, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 50) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -83326, 242964, -3718, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -83175, 243065, -3718, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 53) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -82809, 242751, -3718, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 54) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -81895, 243917, -3721, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 55) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -81840, 243534, -3721, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 56) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -81512, 243424, -3720, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -78939, 240305, -3443, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 59) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -85301, 244587, -3725, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 60) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -83163, 243560, -3728, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 61) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -97131, 258946, -3622, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 62) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -114685, 222291, -2925, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -100332, 238019, -3573, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");

} else if (reply == 65) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -82041, 242718, -3725, 2);
myself.ShowPage(talker, "guide_human_cnacelot_q0255_05.htm");
