...
if (gg.HaveMemo(target, 277) == 1 && gg.OwnItemCount(target, 1572) < 20) {
...
if (gg.Rand(2) == 0) {
if (gg.OwnItemCount(target, 1572) >= 19) {
myself.GiveItem1(target, 1572, 1);
myself.SetFlagJournal(target, 277, 2);
myself.ShowQuestMark(target, 277);
