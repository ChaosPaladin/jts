...
public class fallenangel_allector_2 extends lv3_wizard {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 89) == 1 && target.occupation == 27 && gg.GetMemoState(target, 89) == 7 && gg.OwnItemCount(target, 7349) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8952, "", "", "", "", ""));
myself.GiveItem1(target, 7349, 1);
myself.SetFlagJournal(target, 89, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8950, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8951, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
