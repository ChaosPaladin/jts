...
if (gg.HaveMemo(c1, 217) && gg.GetMemoState(c1, 217) == 2 && gg.OwnItemCount(c1, 2746) == 0) {
if (gg.OwnItemCount(c1, 2747)) {
myself.GiveItem1(c1, 2746, 1);
myself.SetMemoState(c1, 217, 3);
myself.SoundEffect(c1, "Itemsound.quest_middle");
myself.SetFlagJournal(c1, 217, 3);
...
myself.SetCurrentQuestID(217);
myself.AddTimerEx(21701, 1000 * 200);
super;
	}
