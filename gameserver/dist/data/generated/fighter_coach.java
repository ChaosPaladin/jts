...
public class fighter_coach extends guild_coach {
	protected void LEARN_SKILL_REQUESTED(HandlerParam talker) {
if (myself.sm.race == 0 && myself.IsInCategory(44, talker.occupation) || myself.sm.race == 1 && myself.IsInCategory(48, talker.occupation) || myself.sm.race == 2 && myself.IsInCategory(52, talker.occupation) || myself.sm.race == 3 && myself.IsInCategory(56, talker.occupation) || myself.sm.race == 4 && myself.IsInCategory(60, talker.occupation)) {
