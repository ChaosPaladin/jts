...
public class dusk_acolyte1 extends ssq_main_event_acolyte {
...
if (gg.AddPartyToEventRoom(1, 1, party0.id)) {
...
gg.AddPartyToEventRoom(1, 1, party0.id);
...
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_20a.htm");
...
} else if (gg.StrToInt(gg.GetTimeAttackRecordInfo(1, 1, 4, 0)) > gg.OwnItemCount(talker, 5901)) {
i1 = gg.Party_GetCount(talker);
for (i0 = 0; i0 < i1; i0 = i0 + 1) {
c1 = gg.Party_GetCreature(talker, i0);
...
myself.AddTimeAttackRecord(1, 1, party0.id, gg.OwnItemCount(talker, 5901), gg.GetTimeOfDay(), gg.GetMemoState(talker, 505));
