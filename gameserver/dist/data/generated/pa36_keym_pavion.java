...
public class pa36_keym_pavion extends ai_keym_pavion {
...
if (gg.HaveMemo(target, 128) == 1 && gg.GetMemoState(target, 128) == 4 && myself.GetOneTimeQuestFlag(target, 128) == 0) {
...
myself.GiveItem1(target, 13133, 1);
myself.DeleteItem1(target, 13132, gg.OwnItemCount(target, 13132));
myself.SetMemoState(target, 128, 5);
myself.SetFlagJournal(target, 128, 5);
