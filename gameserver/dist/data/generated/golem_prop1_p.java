...
public class golem_prop1_p extends ai_golem_revive {
...
target = code_info.RandomSelectOne();
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.GetMemoStateEx(target, 463, 2) == 1) {
i0 = gg.Rand(100);
i0 = i0 + 1;
...
} else if (gg.OwnItemCount(target, 15510) > 2) {
myself.DeleteItem1(target, 15510, 2);
