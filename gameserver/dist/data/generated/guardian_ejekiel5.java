...
public class guardian_ejekiel5 extends lv3_dagger {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 80) == 1 && target.occupation == 23 && gg.GetMemoState(target, 80) == 7 && gg.OwnItemCount(target, 7340) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8052, "", "", "", "", ""));
myself.GiveItem1(target, 7340, 1);
myself.SetFlagJournal(target, 80, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8050, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8051, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
