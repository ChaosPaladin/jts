...
public class crimson_duchess extends lv3_ranger {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 69) == 1 && target.occupation == 130 && gg.GetMemoState(target, 69) == 7 && gg.OwnItemCount(target, 9730) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(6952, "", "", "", "", ""));
myself.GiveItem1(target, 9730, 1);
myself.SetFlagJournal(target, 69, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(6950, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(6951, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
