...
public class fallenangel_naverius_1 extends lv3_song_dance {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 86) == 1 && target.occupation == 17 && gg.GetMemoState(target, 86) == 7 && gg.OwnItemCount(target, 7346) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8652, "", "", "", "", ""));
myself.GiveItem1(target, 7346, 1);
myself.SetFlagJournal(target, 86, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8650, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8651, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
