...
super;
	...
	protected void ATTACKED(HandlerParam attacker, HandlerParam damage, HandlerParam skill_name_id, HandlerParam i0, HandlerParam f0, HandlerParam h0, HandlerParam i1) {
i0 = 0;
...
if (gg.Rand(100) <= myself.i_ai2 * 20) {
...
if (gg.Rand(100) > 50) {
if (gg.Rand(100) < 50) {
myself.CreateOnePrivateEx(silhouette1, ai_type1, 0, 0, gg.FloatToInt(myself.sm.x), gg.FloatToInt(myself.sm.y), gg.FloatToInt(myself.sm.z), i0 * 182, gg.GetIndexFromCreature(myself.c_ai0), myself.i_ai3, 0);
