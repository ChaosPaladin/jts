...
i4 = gg.Rand(1000);
if (i4 < 658) {
myself.GiveItem1(target, 6008, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else if (i4 < 100) {
myself.GiveItem1(target, 6019, 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(1000) < 935) {
myself.GiveItem1(target, 7586, 5);
myself.SoundEffect(target, "ItemSound.quest_itemget");
...
if (gg.GetMemoStateEx(target, 348, 1) + 600 > 80000) {
...
i0 = i0 + 600;
myself.SetMemoStateEx(target, 348, 1, i0);
if (gg.GetMemoStateEx(target, 348, 1) + 600 > 100000) {
myself.GiveItem1(target, 4295, 1);
myself.DeleteItem1(target, 4294, 1);
...
if (gg.GetMemoStateEx(c2, 348, 1) + 60 > 80000) {
...
i0 = i0 + 60;
myself.SetMemoStateEx(c2, 348, 1, i0);
if (gg.GetMemoStateEx(c2, 348, 1) + 60 > 100000) {
myself.GiveItem1(c2, 4295, 1);
myself.DeleteItem1(c2, 4294, 1);
