...
public class overlord_atrus extends lv3_orc {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 77) == 1 && target.occupation == 51 && gg.GetMemoState(target, 77) == 7 && gg.OwnItemCount(target, 7337) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(7752, "", "", "", "", ""));
myself.GiveItem1(target, 7337, 1);
myself.SetFlagJournal(target, 77, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(7750, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(7751, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
