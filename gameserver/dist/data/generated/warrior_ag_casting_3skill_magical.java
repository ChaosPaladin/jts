...
if (myself.GetLifeTime() > 7 && myself.InMyTerritory(myself.sm) && creature.is_pc != 0 || myself.IsInCategory(12, creature.npc_class_id)) {
i6 = gg.Rand(100);
if (myself.DistFromMe(creature) > 100 && i6 < 33 && myself.p_state != 3) {
