...
public class swordplayer_baiel extends lv3_song_dance {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 72) == 1 && target.occupation == 21 && gg.GetMemoState(target, 72) == 7 && gg.OwnItemCount(target, 7332) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(7252, "", "", "", "", ""));
myself.GiveItem1(target, 7332, 1);
myself.SetFlagJournal(target, 72, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(7250, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(7251, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
