...
public class adiantum extends ai_adiantum_boss {
...
if (gg.HaveMemo(target, 128) == 1 && gg.GetMemoState(target, 128) == 8 && myself.GetOneTimeQuestFlag(target, 128) == 0) {
...
myself.DeleteItem1(target, 13136, gg.OwnItemCount(target, 13136));
myself.SetMemoState(target, 128, 9);
myself.SetFlagJournal(target, 128, 9);
