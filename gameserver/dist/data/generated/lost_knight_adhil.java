...
public class lost_knight_adhil extends lv3_knight {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 70) == 1 && target.occupation == 5 && gg.GetMemoState(target, 70) == 7 && gg.OwnItemCount(target, 7330) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(7052, "", "", "", "", ""));
myself.GiveItem1(target, 7330, 1);
myself.SetFlagJournal(target, 70, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(7050, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(7051, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
