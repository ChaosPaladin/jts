...
if (gg.HaveMemo(myself.c_quest0, 411) == 1 && gg.OwnItemCount(myself.c_quest0, 1247) == 1 && myself.i_quest0 == 1 && gg.OwnItemCount(myself.c_quest0, 1248) < 10) {
myself.GiveItem1(myself.c_quest0, 1248, 1);
if (gg.OwnItemCount(myself.c_quest0, 1248) >= 9) {
myself.SoundEffect(myself.c_quest0, "ItemSound.quest_middle");
myself.SetFlagJournal(myself.c_quest0, 411, 4);
myself.ShowQuestMark(myself.c_quest0, 411);
