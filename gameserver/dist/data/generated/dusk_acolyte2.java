...
public class dusk_acolyte2 extends ssq_main_event_acolyte {
...
myself.FHTML_SetFileName(fhtml0, "ssq_main_event_acolyte_q0505_04b.htm");
myself.FHTML_SetStr(fhtml0, "name", c1.name);
myself.ShowFHTML(talker, fhtml0);
myself.RemoveMemo(talker, 505);
return;

} else if (c1.max_magic_level > 42) {
...
if (gg.GetMemoStateEx(talker, 505, 1) == 1500) {
if (gg.OwnItemCount(talker, 6360) < 1500) {
...
if (gg.OwnItemCount(talker, 6361) < 900) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_21b.htm");
return;
...
if (gg.GetMemoStateEx(talker, 505, 1) == 450) {
if (gg.OwnItemCount(talker, 6362) < 450) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_21b.htm");
return;
...
if (gg.AddPartyToEventRoom(2, 1, party0.id)) {
...
myself.DeleteItem1(talker, 6360, 1500);
...
myself.DeleteItem1(talker, 6361, 900);
...
myself.DeleteItem1(talker, 6362, 450);
...
myself.SetMemoStateEx(talker, 505, 1, 2);
gg.AddPartyToEventRoom(2, 1, party0.id);
...
myself.AddTimeAttackFee(2, 4500, party0.id);
...
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_20b.htm");
...
} else if (gg.GetMemoStateEx(talker, 505, 1) != 2) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_28.htm");

} else if (gg.StrToInt(gg.GetTimeAttackRecordInfo(2, 1, 4, 0)) > gg.OwnItemCount(talker, 5901)) {
i1 = gg.Party_GetCount(talker);
for (i0 = 0; i0 < i1; i0 = i0 + 1) {
c1 = gg.Party_GetCreature(talker, i0);
...
myself.Shout(gg.MakeFString(50503, talker.name, gg.IntToStr(43), gg.IntToStr(i2), "", ""));
...
myself.AddTimeAttackRecord(2, 1, party0.id, gg.OwnItemCount(talker, 5901), gg.GetTimeOfDay(), gg.GetMemoState(talker, 505));
...
if (gg.IsWinnerOfTimeAttackEvent(talker, 2) == 0) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_17.htm");
return;

}
if (gg.GetTimeAttackRewardFlag(talker, 2)) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_19.htm");
return;

}
i0 = gg.StrToInt(gg.GetTimeAttackRecordInfo(2, gg.GetSSQPart(talker), 2, 0));
i1 = myself.GetTimeAttackFee(2) / i0;
myself.GiveTimeAttackReward(talker, 2, 5575, i1);
...
myself.SetMemoStateEx(talker, 505, 1, 1500);
...
myself.SetMemoStateEx(talker, 505, 1, 450);
myself.FHTML_SetFileName(fhtml0, "ssq_main_event_acolyte_q0505_06.htm");
myself.FHTML_SetInt(fhtml0, "quest_id", 505);
myself.ShowFHTML(talker, fhtml0);
