...
public class draconian_eliteguard_ret extends ai_destruct_warrior_dd_self {
...
i0 = gg.Rand(1000);
if (i0 < 464) {
myself.GiveItem1(target, 13865, gg.Rand(3) + 1 * 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else {
myself.GiveItem1(target, 13865, gg.Rand(4) + 3 * 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");
...
i0 = gg.Rand(1000);
if (i0 < 545) {
myself.GiveItem1(target, 13853, gg.Rand(5) + 5);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else {
myself.GiveItem1(target, 13853, gg.Rand(3) + 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");
