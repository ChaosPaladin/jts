...
public class kimera_golem extends lv3_knight {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 97) == 1 && target.occupation == 33 && gg.GetMemoState(target, 97) == 7 && gg.OwnItemCount(target, 7357) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9752, "", "", "", "", ""));
myself.GiveItem1(target, 7357, 1);
myself.SetFlagJournal(target, 97, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9750, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9751, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
