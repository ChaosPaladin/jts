...
public class fortress_subpower extends citizen {
	protected String fnHi2 = "";
	protected String fnHi3 = "";
	protected int secret_number = 1;
	protected int broadcast_range = 1000;
	protected int broadcast_msg = 1005;
	protected String fnGetPasswd = "fortress_subpower004.htm";
	protected int fstr_1stpasswd = 1300129;
	protected int fstr_2ndpasswd = 1300130;
	protected int fstr_nopasswd = 1300131;
	protected int fstr_try_limit = 1300128;
	protected int try_limit = 3;
	protected int try_delay = 30;
	protected int puzzle_range = 4;
...
if (myself.i_ai0 == -1 && myself.i_ai1 == -1 && myself.i_ai2 == -1) {
myself.BroadcastScriptEvent(broadcast_msg, secret_number, broadcast_range);
myself.ShowPage(talker, fnHi2);
