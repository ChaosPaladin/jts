...
public class magister_page extends wizard_coach {
...
talker.param3 = 0;
talker.flag = 0;
myself.ShowPage(talker, "magister_page_q0336_01.htm");
...
if (ask == 336) {
if (reply == 1) {
myself.ShowPage(talker, "magister_page_q0336_02.htm");
talker.param2 = 11;

} else if (reply == 2) {
myself.ShowPage(talker, "magister_page_q0336_03.htm");
talker.param2 = 21;

} else if (reply == 3) {
myself.ShowPage(talker, "magister_page_q0336_04.htm");
talker.param2 = 31;

} else if (reply == 4) {
myself.ShowPage(talker, "magister_page_q0336_05.htm");
talker.param2 = 42;

} else if (reply == 5) {
myself.ShowPage(talker, "magister_page_q0336_06.htm");

} else if (reply == 6) {
if (talker.param2 == 42) {
if (gg.OwnItemCount(talker, 3472) >= 4 * 2) {
talker.flag = 1;
myself.DeleteItem1(talker, 3472, 4 * 2);
myself.ShowPage(talker, "magister_page_q0336_11.htm");
...
myself.ShowPage(talker, "magister_page_q0336_10.htm");
...
if (talker.param2 == 42) {
if (gg.OwnItemCount(talker, 3472) >= 8 * 2) {
talker.flag = 1;
myself.DeleteItem1(talker, 3472, 8 * 2);
myself.ShowPage(talker, "magister_page_q0336_12.htm");
...
if (talker.param2 == 42) {
if (gg.OwnItemCount(talker, 3472) >= 9 * 2) {
talker.flag = 1;
myself.DeleteItem1(talker, 3472, 9 * 2);
myself.ShowPage(talker, "magister_page_q0336_13.htm");
...
myself.ShowPage(talker, "magister_page_q0336_53.htm");

} else if (reply == 10) {
if (talker.param2 == 42) {
if (gg.OwnItemCount(talker, 3472) >= 10 * 2) {
myself.ShowPage(talker, "magister_page_q0336_07.htm");
myself.DeleteItem1(talker, 3472, 10 * 2);
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(talker, 3480, 1);
...
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(talker, 3491, 1);
myself.SoundEffect(talker, "ItemSound.quest_middle");
...
if (talker.param2 == 42) {
if (gg.OwnItemCount(talker, 3472) >= 10 * 5 * 2) {
myself.ShowPage(talker, "magister_page_q0336_07.htm");
myself.DeleteItem1(talker, 3472, 10 * 5 * 2);
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(talker, 3480, 5);
myself.SoundEffect(talker, "ItemSound.quest_middle");
...
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(talker, 3491, 5);
myself.SoundEffect(talker, "ItemSound.quest_middle");
...
if (talker.param2 == 42) {
if (gg.OwnItemCount(talker, 3472) >= 10 * 10 * 2) {
myself.ShowPage(talker, "magister_page_q0336_07.htm");
myself.DeleteItem1(talker, 3472, 10 * 10 * 2);
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(talker, 3480, 10);
myself.SoundEffect(talker, "ItemSound.quest_middle");
...
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(talker, 3491, 10);
myself.SoundEffect(talker, "ItemSound.quest_middle");
...
talker.flag = 0;
myself.ShowPage(talker, "magister_page_q0336_14.htm");
talker.flag = talker.flag + 4 * 4 * 1;

} else if (reply == 14 && talker.flag == 1) {
talker.flag = 0;
myself.ShowPage(talker, "magister_page_q0336_15.htm");
talker.flag = talker.flag + 4 * 4 * 2;

} else if (reply == 15 && talker.flag == 1) {
talker.flag = 0;
myself.ShowPage(talker, "magister_page_q0336_16.htm");
talker.flag = talker.flag + 4 * 4 * 3;

} else if (reply == 16) {
myself.ShowPage(talker, "magister_page_q0336_17.htm");
talker.flag = talker.flag + 4 * 1 * 1;

} else if (reply == 17) {
myself.ShowPage(talker, "magister_page_q0336_18.htm");
talker.flag = talker.flag + 4 * 1 * 2;

} else if (reply == 18) {
myself.ShowPage(talker, "magister_page_q0336_19.htm");
...
talker.quest_last_reward_time = myself.GetCurrentTick();
talker.weight_point = 0;
myself.ShowPage(talker, "magister_page_q0336_20.htm");
if (talker.param2 == 42) {
myself.GiveItem1(talker, 3480, 1);
...
if (talker.param1 == 21) {
myself.ShowPage(talker, "magister_page_q0336_23.htm");

} else if (talker.param1 == 25) {
myself.ShowPage(talker, "magister_page_q0336_24.htm");

} else if (talker.param1 == 37) {
myself.ShowPage(talker, "magister_page_q0336_25.htm");

} else if (talker.param1 == 41) {
myself.ShowPage(talker, "magister_page_q0336_26.htm");

} else if (talker.param1 == 61) {
myself.ShowPage(talker, "magister_page_q0336_27.htm");

} else if (talker.param1 == 29) {
myself.ShowPage(talker, "magister_page_q0336_28.htm");

} else if (talker.param1 == 45) {
myself.ShowPage(talker, "magister_page_q0336_29.htm");

} else if (talker.param1 == 53) {
myself.ShowPage(talker, "magister_page_q0336_30.htm");

} else if (talker.param1 == 57) {
myself.ShowPage(talker, "magister_page_q0336_31.htm");

} else if (talker.param1 == 22) {
myself.ShowPage(talker, "magister_page_q0336_32.htm");

} else if (talker.param1 == 26) {
myself.ShowPage(talker, "magister_page_q0336_33.htm");

} else if (talker.param1 == 38) {
myself.ShowPage(talker, "magister_page_q0336_34.htm");

} else if (talker.param1 == 42) {
myself.ShowPage(talker, "magister_page_q0336_35.htm");

} else if (talker.param1 == 62) {
myself.ShowPage(talker, "magister_page_q0336_36.htm");

} else if (talker.param1 == 30) {
myself.ShowPage(talker, "magister_page_q0336_37.htm");

} else if (talker.param1 == 46) {
myself.ShowPage(talker, "magister_page_q0336_38.htm");

} else if (talker.param1 == 54) {
myself.ShowPage(talker, "magister_page_q0336_39.htm");

} else if (talker.param1 == 58) {
myself.ShowPage(talker, "magister_page_q0336_40.htm");

} else if (talker.param1 == 23) {
myself.ShowPage(talker, "magister_page_q0336_41.htm");

} else if (talker.param1 == 27) {
myself.ShowPage(talker, "magister_page_q0336_42.htm");

} else if (talker.param1 == 39) {
myself.ShowPage(talker, "magister_page_q0336_43.htm");

} else if (talker.param1 == 43) {
myself.ShowPage(talker, "magister_page_q0336_44.htm");

} else if (talker.param1 == 63) {
myself.ShowPage(talker, "magister_page_q0336_45.htm");

} else if (talker.param1 == 31) {
myself.ShowPage(talker, "magister_page_q0336_46.htm");

} else if (talker.param1 == 47) {
myself.ShowPage(talker, "magister_page_q0336_47.htm");

} else if (talker.param1 == 55) {
myself.ShowPage(talker, "magister_page_q0336_48.htm");

} else if (talker.param1 == 59) {
myself.ShowPage(talker, "magister_page_q0336_49.htm");
...
if (talker.param3 == 1) {
myself.ShowPage(talker, "magister_page_q0336_50.htm");

} else if (talker.param3 == 2) {
myself.ShowPage(talker, "magister_page_q0336_51.htm");

} else if (talker.param3 == 0) {
myself.ShowPage(talker, "magister_page_q0336_52.htm");
