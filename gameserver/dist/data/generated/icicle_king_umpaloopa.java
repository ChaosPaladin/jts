...
public class icicle_king_umpaloopa extends raid_boss_type5 {
...
target = last_attacker;
if (gg.HaveMemo(target, 625) == 1 && gg.GetMemoState(target, 625) >= 2 * 10 - 9 && gg.GetMemoState(target, 625) <= 2 * 10 + 1) {
...
myself.GiveItem1(target, 7210, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
myself.SetFlagJournal(target, 625, 3);
myself.ShowQuestMark(target, 625);
myself.SetMemoState(target, 625, 2 * 10 + 2);

} else if (gg.GetMemoState(target, 625) == 21) {
myself.GiveItem1(target, 7210, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
myself.SetFlagJournal(target, 625, 3);
myself.ShowQuestMark(target, 625);
...
} else if (gg.OwnItemCount(target, 7209) >= 1) {
myself.DeleteItem1(target, 7209, 1);
myself.GiveItem1(target, 7210, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
myself.SetFlagJournal(target, 625, 3);
myself.ShowQuestMark(target, 625);
...
myself.SetCurrentQuestID(625);
if (timer_id == 625 * 100 + 1) {
myself.Say(gg.MakeFString(62504, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param1);
if (gg.IsNull(npc0) == 0) {
npc0.av_quest0.Exchange(0);
...
myself.Say(gg.MakeFString(62503, "", "", "", "", ""));
super;
	}
