...
if (gg.HaveMemo(myself.c_quest0, 410) == 1 && gg.OwnItemCount(myself.c_quest0, 1240) == 1 && myself.i_quest0 == 1 && gg.OwnItemCount(myself.c_quest0, 1242) < 5) {
myself.GiveItem1(myself.c_quest0, 1242, 1);
if (gg.OwnItemCount(myself.c_quest0, 1242) >= 4 && gg.OwnItemCount(myself.c_quest0, 1241) == 1) {
myself.SetFlagJournal(myself.c_quest0, 410, 5);
myself.ShowQuestMark(myself.c_quest0, 410);

}
if (gg.OwnItemCount(myself.c_quest0, 1242) >= 4) {
