...
public class ssq_npc_merchant_of_mammon extends citizen {
...
if (gg.GetSSQPart(talker) != 0 && myself.GetSSQSealOwner(1) == gg.GetSSQPart(talker)) {
myself.ShowPage(talker, fnHi);

} else {
myself.ShowPage(talker, "merchant_of_mammon002.htm");
