...
public class secret_keeper_shakiel3 extends lv3_summoner {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 93) == 1 && target.occupation == 41 && gg.GetMemoState(target, 93) == 7 && gg.OwnItemCount(target, 7353) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9352, "", "", "", "", ""));
myself.GiveItem1(target, 7353, 1);
myself.SetFlagJournal(target, 93, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9350, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9351, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
