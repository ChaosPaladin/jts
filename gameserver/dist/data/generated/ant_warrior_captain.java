...
if (gg.HaveMemo(c1, 213) && gg.OwnItemCount(c1, 2667) == 1 && gg.OwnItemCount(c1, 2670) == 0) {
if (gg.Rand(100) < 100) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2670, 1);
myself.SoundEffect(c1, "ItemSound.quest_middle");
if (gg.OwnItemCount(c1, 2668) >= 1 && gg.OwnItemCount(c1, 2669) >= 1 && gg.OwnItemCount(c1, 2671) >= 1) {
