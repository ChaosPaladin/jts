...
public class secret_keeper_shakiel1 extends lv3_summoner {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 91) == 1 && target.occupation == 14 && gg.GetMemoState(target, 91) == 7 && gg.OwnItemCount(target, 7351) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9152, "", "", "", "", ""));
myself.GiveItem1(target, 7351, 1);
myself.SetFlagJournal(target, 91, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9150, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9151, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
