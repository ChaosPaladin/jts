...
public class cruma_ev_fl1_1st extends cruma_fl1_parameter {
	protected String next_maker_name = "spawn_serial_default";
...
if (gg.IsNull(maker0) == 0) {
gg.SendMakerScriptEvent(maker0, 1001, myself.i_ai0, 1);
