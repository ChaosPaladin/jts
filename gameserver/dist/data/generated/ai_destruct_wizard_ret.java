...
public class ai_destruct_wizard_ret extends ai_destruct_basic_ret {
...
} else if (attacker.is_pc == 1 || attacker.npc_class_id == 1018775) {
...
myself.MakeAttackEvent(creature, 500, 0);
