...
public class varka_commnder_mos extends raid_boss_type2 {
...
target = last_attacker;
if (gg.HaveMemo(target, 608) == 1 && gg.GetMemoState(target, 608) == 1 * 10 + 1) {
...
i4 = gg.Rand(1000);
if (i4 < 1000) {
if (gg.OwnItemCount(target, 7236) + 1 >= 1) {
if (gg.OwnItemCount(target, 7236) < 1) {
myself.GiveItem1(target, 7236, 1 - gg.OwnItemCount(target, 7236));
myself.SoundEffect(target, "ItemSound.quest_middle");
myself.SetFlagJournal(target, 608, 2);
myself.ShowQuestMark(target, 608);
myself.SetMemoState(target, 608, 1 * 10 + 2);

}

} else {
myself.GiveItem1(target, 7236, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
