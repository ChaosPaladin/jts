...
public class elite_traikhan extends ai_elite_traikhan {
...
target = last_attacker;
if (gg.HaveMemo(target, 453) == 1 && gg.GetMemoState(target, 453) == 1 && gg.GetMemoStateEx(target, 453, 1) == 1) {
...
myself.SetCurrentQuestID(453);
myself.IncreaseNPCLogByID(target, 453, 0, 1022749, 15);
if (myself.GetNPCLogByID(target, 453, 0, 1022746) >= 15 && myself.GetNPCLogByID(target, 453, 0, 1022747) >= 15 && myself.GetNPCLogByID(target, 453, 0, 1022748) >= 15 && myself.GetNPCLogByID(target, 453, 0, 1022749) >= 15) {
