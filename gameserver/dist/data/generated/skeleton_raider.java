...
if (gg.HaveMemo(c1, 212) && gg.GetMemoState(c1, 212) == 2) {
if (gg.Rand(100) < c1.flag * 10) {
myself.CreateOnePrivateEx(1027119, "spirit_of_sir_herod", 0, 0, gg.FloatToInt(myself.sm.x), gg.FloatToInt(myself.sm.y), gg.FloatToInt(myself.sm.z), 0, 0, 0, 0);
