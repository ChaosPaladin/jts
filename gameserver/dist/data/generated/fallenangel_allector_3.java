...
public class fallenangel_allector_3 extends lv3_wizard {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 90) == 1 && target.occupation == 40 && gg.GetMemoState(target, 90) == 7 && gg.OwnItemCount(target, 7350) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9052, "", "", "", "", ""));
myself.GiveItem1(target, 7350, 1);
myself.SetFlagJournal(target, 90, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9050, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9051, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
