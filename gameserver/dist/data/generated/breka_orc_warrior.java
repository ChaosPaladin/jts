...
target = last_attacker;
if (gg.HaveMemo(target, 335) && gg.OwnItemCount(target, 3695) && gg.OwnItemCount(target, 3711) + gg.OwnItemCount(target, 3712) + gg.OwnItemCount(target, 3713) < 3) {
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(10) < 2) {
if (gg.OwnItemCount(target, 3711) == 0) {
myself.CreateOnePrivate(1027140, "breka_overlord_haka", 0, 1);

} else if (gg.OwnItemCount(target, 3712) == 0) {
myself.CreateOnePrivate(1027141, "breka_overlord_jaka", 0, 1);

} else if (gg.OwnItemCount(target, 3713) == 0) {
myself.CreateOnePrivate(1027142, "breka_overlord_marka", 0, 1);
