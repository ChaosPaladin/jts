...
public class guide_delf_frankia extends newbie_guide {
protected Object[][] Position = {
{"Dwarven Village";115632;-177996;-905;0;0}, {"Talking Island Village";-84081;243227;-3723;0;0}, {"Elven Village";45475;48359;-3060;0;0}, {"Orc Village";-45032;-113598;-192;0;0}, {"Kamael Village";-119697;44532;380;0;0}
};
...
if (ask == 255) {
if (reply == 10) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04.htm");

} else if (reply == 11) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04a.htm");

} else if (reply == 12) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04b.htm");

} else if (reply == 13) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04c.htm");

} else if (reply == 14) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04d.htm");

} else if (reply == 15) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04e.htm");

} else if (reply == 16) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04f.htm");

} else if (reply == 17) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04g.htm");

} else if (reply == 18) {
myself.ShowPage(talker, "guide_delf_frankia_q0255_04h.htm");

} else if (reply == 31) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 9670, 15537, -4574, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 32) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 15120, 15656, -4376, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 33) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 17306, 13592, -3724, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 34) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 15272, 16310, -4377, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 35) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 6449, 19619, -3694, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 36) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -15404, 71131, -3445, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 37) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 7496, 17388, -4377, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 38) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 17102, 13002, -3743, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 39) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 6532, 19903, -3693, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 40) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -15648, 71405, -3451, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -1301, 75883, -3566, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 43) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -1152, 76125, -3566, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 12009, 15704, -4554, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 46) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 11951, 15661, -4554, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 47) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 10761, 17970, -4554, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 48) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 10823, 18013, -4554, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 49) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 11283, 14226, -4242, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 10315, 14293, -4242, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");
...
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 11235, 14078, -4242, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 56) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 11012, 14128, -4242, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 57) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 13380, 17430, -4542, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 58) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 13464, 17751, -4541, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 59) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 13763, 17501, -4542, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 60) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -44225, 79721, -3652, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 61) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, -44015, 79683, -3652, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 62) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 25856, 10832, -3724, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 63) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 12328, 14947, -4574, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 64) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 13081, 18444, -4573, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");

} else if (reply == 65) {
myself.DeleteAllRadar(talker, 2);
myself.ShowRadar(talker, 12311, 17470, -4574, 2);
myself.ShowPage(talker, "guide_delf_frankia_q0255_05.htm");
