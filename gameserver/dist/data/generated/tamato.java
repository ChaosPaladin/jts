...
if (gg.HaveMemo(myself.c_quest0, 409) == 1 && gg.OwnItemCount(myself.c_quest0, 1275) == 0 && myself.i_quest0 == 1) {
myself.GiveItem1(myself.c_quest0, 1275, 1);
myself.SetFlagJournal(myself.c_quest0, 409, 5);
...
case 0: {
myself.Say(gg.MakeFString(40913, "", "", "", "", ""));
myself.i_quest0 = 1;
if (attacker.master) {
