...
if (myself.IsNullCreature(speller.master) && gg.OwnItemCount(speller.master, FriendShip1) >= 1 || gg.OwnItemCount(speller.master, FriendShip2) >= 1 || gg.OwnItemCount(speller.master, FriendShip3) >= 1 || gg.OwnItemCount(speller.master, FriendShip4) >= 1 || gg.OwnItemCount(speller.master, FriendShip5) >= 1) {
if (myself.Skill_GetConsumeMP(DeBuff1) < myself.sm.mp && myself.Skill_GetConsumeHP(DeBuff1) < myself.sm.hp && myself.Skill_InReuseDelay(DeBuff1) == 0) {
myself.AddUseSkillDesire(speller, DeBuff1, 0, 1, 1000000);
