...
c1.quest_last_reward_time = myself.GetCurrentTick();
if (gg.HaveMemo(c1, 335)) {
if (gg.OwnItemCount(c1, 3728) && gg.OwnItemCount(c1, 3770) < 50) {
if (gg.Rand(100) < 95) {
...
if (gg.OwnItemCount(c1, 3696) && gg.OwnItemCount(c1, 3717) < 20) {
if (gg.Rand(100) < 60) {
myself.GiveItem1(c1, 3717, 1);
if (gg.OwnItemCount(c1, 3717) >= 20) {
myself.SoundEffect(c1, "ItemSound.quest_middle");
...
if (gg.OwnItemCount(c1, 3743) && gg.OwnItemCount(c1, 3785) < 1) {
if (gg.Rand(10) < 2) {
myself.CreateOnePrivate(1027158, "timak_raider_kaikee", 0, 1);
