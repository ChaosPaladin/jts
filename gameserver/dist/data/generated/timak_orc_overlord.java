...
if (gg.HaveMemo(c1, 222) && gg.OwnItemCount(c1, 2778) > 0 && gg.OwnItemCount(c1, 2782) < 3 && gg.GetMemoState(c1, 222) == 2) {
i0 = gg.GetMemoStateEx(c1, 222, 1);
myself.SetMemoStateEx(c1, 222, 1, i0 + 1);
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2782, 1);
if (gg.OwnItemCount(c1, 2782) >= 3) {
myself.SoundEffect(c1, "ItemSound.quest_middle");
if (i0 >= 5) {
...
c1.quest_last_reward_time = myself.GetCurrentTick();
if (gg.HaveMemo(c1, 335) && gg.OwnItemCount(c1, 3728) && gg.OwnItemCount(c1, 3770) < 50) {
myself.GiveItem1(c1, 3770, 1);
if (gg.OwnItemCount(c1, 3770) >= 50) {
myself.SoundEffect(c1, "ItemSound.quest_middle");
...
if (gg.HaveMemo(c1, 335) && gg.OwnItemCount(c1, 3760) && gg.OwnItemCount(c1, 3802) < 1) {
if (gg.Rand(10) == 0) {
myself.CreateOnePrivate(1027159, "timak_overlord_okun", 0, 1);
