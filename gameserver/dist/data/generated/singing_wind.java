...
if (gg.HaveMemo(target, 50) == 1 && myself.GetOneTimeQuestFlag(target, 50) == 0 && gg.GetMemoState(target, 50) == 1 * 10 + 1) {
...
i4 = gg.Rand(1000);
if (i4 < 500 && 500 != 0) {
if (gg.OwnItemCount(target, 7621) + 1 >= 100) {
if (gg.OwnItemCount(target, 7621) < 100) {
myself.GiveItem1(target, 7621, 100 - gg.OwnItemCount(target, 7621));
myself.SoundEffect(target, "ItemSound.quest_middle");
myself.SetFlagJournal(target, 50, 2);
myself.ShowQuestMark(target, 50);

}
myself.SetMemoState(target, 50, 1 * 10 + 2);

} else {
myself.GiveItem1(target, 7621, 1);
