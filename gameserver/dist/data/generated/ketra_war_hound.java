...
target = last_attacker;
if (gg.HaveMemo(target, 611) == 1 && gg.OwnItemCount(target, 7221) + gg.OwnItemCount(target, 7222) + gg.OwnItemCount(target, 7223) + gg.OwnItemCount(target, 7224) + gg.OwnItemCount(target, 7225) == 0 && gg.OwnItemCount(target, 7226) < 100 || gg.OwnItemCount(target, 7221) >= 1 && gg.OwnItemCount(target, 7226) < 200 || gg.OwnItemCount(target, 7222) >= 1 && gg.OwnItemCount(target, 7226) < 300 || gg.OwnItemCount(target, 7223) >= 1 && gg.OwnItemCount(target, 7226) < 300 || gg.OwnItemCount(target, 7224) >= 1 && gg.OwnItemCount(target, 7226) < 400) {
...
i4 = gg.Rand(1000);
if (i4 < 500) {
myself.GiveItem1(target, 7226, 1);
