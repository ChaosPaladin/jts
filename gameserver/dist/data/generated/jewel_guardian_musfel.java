...
if (gg.GetMemoState(target, 337) == 40000 || gg.GetMemoState(target, 337) == 40010 && gg.OwnItemCount(target, 3863) == 0 && gg.HaveMemo(target, 337) == 1) {
...
myself.GiveItem1(target, 3863, 1);
...
myself.SetCurrentQuestID(337);
myself.AddTimerEx(233703, 1000 * 3 * 60);
super;
	}
