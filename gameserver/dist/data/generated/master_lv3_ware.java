...
public class master_lv3_ware extends guild_master_lv3 {
	protected int lv2_class1 = 54;
	protected int lv3_class11 = 55;
	protected int proof11x = 3119;
	protected int proof11y = 3238;
	protected int proof11z = 2809;
...
if (ask == -2 && reply == 1) {
if (myself.IsInCategory(9, talker.occupation) && myself.IsInCategory(10, talker.occupation)) {
myself.ShowPage(talker, fnYouAreFourthClass);

} else if (myself.IsInCategory(10, talker.occupation)) {
...
if (c0) {
myself.ShowPage(talker, "master_lv3_ware_02.htm");

} else {
myself.ShowPage(talker, "master_lv3_ware_01.htm");
...
myself.ShowPage(talker, "master_lv3_ware_01b.htm");

} else if (state == 2) {
myself.ShowPage(talker, "master_lv3_ware_01c.htm");

} else if (state == 3) {
myself.ShowPage(talker, "master_lv3_ware_01d.htm");
...
myself.ChangeSubJob(talker, 117);
...
myself.ShowPage(talker, "master_lv3_ware_05.htm");
...
if (i0 != 55 && i0 != 117 && i2 != 55 && i2 != 117 && i4 != 55 && i4 != 117 && i6 == -1 && myself.IsInCategory(8, i0) || myself.IsInCategory(9, i0)) {
myself.CreateSubJob(talker, 55);
...
} else if (i0 != 55 && i0 != 117 && i2 != 55 && i2 != 117 && i4 != 55 && i4 != 117 && i6 != 55 && i6 != 117) {
if (i8 == 1 && i3 < 40) {
myself.ShowPage(talker, "master_lv3_hef_19.htm");
return;
...
myself.RenewSubJob(talker, i8, 55);
...
if (ask == 10) {
if (i2 == -1) {
myself.ShowPage(talker, "master_lv3_ware_07.htm");

} else {
i8 = 0;
myself.FHTML_SetFileName(fhtml0, "master_lv3_ware_03.htm");
if (i0 == 55 || i0 == 117) {
if (i0 > 87) {
i0 = i0 + 1114000;
...
if (ask == 20) {
myself.FHTML_SetFileName(fhtml0, "master_lv3_ware_01a.htm");
if (i2 > 87) {
i2 = i2 + 1110970;
...
myself.ShowPage(talker, "master_lv3_ware_06.htm");
