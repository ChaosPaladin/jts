...
if (gg.HaveMemo(target, 335) && gg.OwnItemCount(target, 3745) && gg.OwnItemCount(target, 3787) < 30) {
...
target = last_attacker;
if (gg.HaveMemo(target, 356) == 1 && gg.OwnItemCount(target, 5865) < 50) {
...
if (gg.Rand(100) < 60) {
myself.GiveItem1(target, 3787, 1);
if (gg.OwnItemCount(target, 3787) >= 30) {
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(100) < 94) {
myself.GiveItem1(target, 5865, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
if (gg.OwnItemCount(target, 5866) >= 50 && gg.OwnItemCount(target, 5865) >= 49) {
myself.SetFlagJournal(target, 356, 3);
myself.ShowQuestMark(target, 356);
myself.SoundEffect(target, "ItemSound.quest_middle");

} else if (gg.OwnItemCount(target, 5865) >= 49) {
