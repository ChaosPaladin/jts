...
public class swordmaster_aion extends lv3_ranger {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 73) == 1 && target.occupation == 2 && gg.GetMemoState(target, 73) == 7 && gg.OwnItemCount(target, 7333) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(7352, "", "", "", "", ""));
myself.GiveItem1(target, 7333, 1);
myself.SetFlagJournal(target, 73, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(7350, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(7351, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
