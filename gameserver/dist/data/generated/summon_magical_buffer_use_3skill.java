...
public class summon_magical_buffer_use_3skill extends default_npc {
...
if (buff6 != 458752001 && buff_action6 != -1) {
if (action_id == buff_action6) {
...
if (buff_target6 == 0) {
myself.AddUseSkillDesireEx(myself.master.target_id, buff6, 0, reply, ask, 1000000, 0);

} else if (buff_target6 == 1 && myself.sm.alive > 0) {
myself.AddUseSkillDesireEx(myself.sm.id, buff6, 0, reply, ask, 1000000, 0);

} else if (buff_target6 == 2 && myself.master.alive > 0) {
myself.AddUseSkillDesireEx(myself.master.id, buff6, 0, reply, ask, 1000000, 0);

}

} else if (myself.Skill_InReuseDelay(buff6) > 0) {
myself.ShowSystemMessage(myself.sm.master, 2396);

} else if (myself.Skill_GetConsumeMP(buff6) >= myself.sm.mp) {
myself.ShowSystemMessage(myself.sm.master, 2394);

} else if (myself.Skill_GetConsumeHP(buff6) >= myself.sm.hp) {
myself.ShowSystemMessage(myself.sm.master, 2395);
