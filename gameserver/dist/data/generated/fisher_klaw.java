...
if (gg.HaveMemo(talker, 79) == 1 && talker.occupation == 8 && gg.GetMemoState(talker, 79) >= 2 && gg.GetMemoState(talker, 79) <= 4 && gg.OwnItemCount(talker, 7516) == 0) {
_choiceN = _choiceN + 1;
_code = 1;
myself.AddChoice(1, "Saga of the Adventurer (In Progress)");

}
if (gg.HaveMemo(talker, 79) == 1 && talker.occupation == 8 && gg.GetMemoState(talker, 79) >= 2 && gg.GetMemoState(talker, 79) <= 4 && gg.OwnItemCount(talker, 7516) >= 1) {
_choiceN = _choiceN + 1;
_code = 2;
myself.AddChoice(2, "Saga of the Adventurer (In Progress)");

}
if (gg.HaveMemo(talker, 79) == 1 && talker.occupation == 8 && gg.GetMemoState(talker, 79) == 5) {
_choiceN = _choiceN + 1;
_code = 3;
...
_choiceN = _choiceN + 1;
_code = 4;
myself.AddChoice(4, "Quest for Fishing shot");

}
if (gg.HaveMemo(talker, 426) == 1 && gg.OwnItemCount(talker, 7586) == 0) {
_choiceN = _choiceN + 1;
_code = 5;
myself.AddChoice(5, "Quest for Fishing shot (In Progress)");

}
if (gg.HaveMemo(talker, 426) == 1 && gg.OwnItemCount(talker, 7586) >= 1) {
_choiceN = _choiceN + 1;
_code = 6;
myself.AddChoice(6, "Quest for Fishing shot (In Progress)");
...
myself.ShowPage(talker, "fisher_klaw_q0079_0101.htm");
...
case 1: {
if (_from_choice == 0 || gg.HaveMemo(talker, 79) == 1 && talker.occupation == 8 && gg.GetMemoState(talker, 79) >= 2 && gg.GetMemoState(talker, 79) <= 4 && gg.OwnItemCount(talker, 7516) == 0) {
myself.SetCurrentQuestID(79);
if (myself.GetInventoryInfo(talker, 0) >= myself.GetInventoryInfo(talker, 1) * 0.800000 || myself.GetInventoryInfo(talker, 2) >= myself.GetInventoryInfo(talker, 3) * 0.800000) {
myself.ShowSystemMessage(talker, 1118);
return;
...
myself.ShowPage(talker, "fisher_klaw_q0079_0102.htm");
...
case 2: {
if (_from_choice == 0 || gg.HaveMemo(talker, 79) == 1 && talker.occupation == 8 && gg.GetMemoState(talker, 79) >= 2 && gg.GetMemoState(talker, 79) <= 4 && gg.OwnItemCount(talker, 7516) >= 1) {
myself.SetCurrentQuestID(79);
if (myself.GetInventoryInfo(talker, 0) >= myself.GetInventoryInfo(talker, 1) * 0.800000 || myself.GetInventoryInfo(talker, 2) >= myself.GetInventoryInfo(talker, 3) * 0.800000) {
myself.ShowSystemMessage(talker, 1118);
return;
...
myself.ShowPage(talker, "fisher_klaw_q0079_0103.htm");
...
case 3: {
if (_from_choice == 0 || gg.HaveMemo(talker, 79) == 1 && talker.occupation == 8 && gg.GetMemoState(talker, 79) == 5) {
myself.SetCurrentQuestID(79);
if (myself.GetInventoryInfo(talker, 0) >= myself.GetInventoryInfo(talker, 1) * 0.800000 || myself.GetInventoryInfo(talker, 2) >= myself.GetInventoryInfo(talker, 3) * 0.800000) {
myself.ShowSystemMessage(talker, 1118);
return;
...
myself.ShowPage(talker, "fisher_klaw_q0079_0104.htm");
...
if (reply == 1) {
if (gg.HaveMemo(talker, 79) == 1 && talker.occupation == 8 && gg.GetMemoState(talker, 79) == 1) {
myself.SetMemoState(talker, 79, 2);
myself.ShowPage(talker, "fisher_klaw_q0079_0105.htm");
myself.SetFlagJournal(talker, 79, 2);
...
if (myself.GetCurrentTick() - talker.quest_last_reward_time > 1) {
talker.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(talker, 7277, 1);
myself.DeleteItem1(talker, 7516, gg.OwnItemCount(talker, 7516));
myself.SetMemoState(talker, 79, 5);
myself.ShowPage(talker, "fisher_klaw_q0079_0106.htm");
myself.SetFlagJournal(talker, 79, 5);
myself.ShowQuestMark(talker, 79);
myself.SoundEffect(talker, "ItemSound.quest_middle");
