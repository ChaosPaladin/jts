...
if (gg.HaveMemo(c1, 379) == 1 && gg.OwnItemCount(c1, 5894) < 100) {
if (myself.GetCurrentTick() - c1.quest_last_reward_time > 1) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 5894, 1);
if (gg.OwnItemCount(c1, 5894) >= 99 && gg.OwnItemCount(c1, 5893) >= 80) {
myself.SetFlagJournal(c1, 379, 2);
myself.ShowQuestMark(c1, 379);

}
if (gg.OwnItemCount(c1, 5894) >= 99) {
