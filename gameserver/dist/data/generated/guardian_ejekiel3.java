...
public class guardian_ejekiel3 extends lv3_ranger {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 84) == 1 && target.occupation == 37 && gg.GetMemoState(target, 84) == 7 && gg.OwnItemCount(target, 7344) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8452, "", "", "", "", ""));
myself.GiveItem1(target, 7344, 1);
myself.SetFlagJournal(target, 84, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8450, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8451, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
