...
public class ai_solina_leader extends warrior {
	protected int MoveAroundSocial = 0;
	protected int Skill01_ID = 413073409;
	protected int Skill02_ID = 413138945;
...
myself.Say("84레벨이상");
if (gg.HaveMemo(c0, 457) == 0) {
myself.Say("메모");

}
if (gg.GetDailyQuestFlag(c0, 457) == 1) {
myself.Say("데일리 1");

}
if (gg.GetDailyQuestFlag(c0, 457) == 0) {
myself.Say("데일리 0");
