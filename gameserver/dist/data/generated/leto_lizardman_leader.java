...
if (gg.HaveMemo(c1, 226) && gg.GetMemoState(c1, 226) == 6 && gg.OwnItemCount(c1, 2816) == 0) {
if (myself.GetCurrentTick() - c1.quest_last_reward_time > 1) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2816, 1);
myself.SoundEffect(c1, "Itemsound.quest_middle");
myself.SetFlagJournal(c1, 226, 12);
...
myself.SetCurrentQuestID(226);
myself.AddTimerEx(22603, 1000 * 200);
super;
	}
