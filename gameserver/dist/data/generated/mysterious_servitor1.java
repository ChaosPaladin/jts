...
if (gg.HaveMemo(c1, 93) == 1 && c1.occupation == 41 && gg.GetMemoState(c1, 93) == 13 || gg.GetMemoState(c1, 93) == 14) {
if (c1.is_pc == 1) {
if (c1.dbid == myself.sm.param2) {
myself.i_quest0 = myself.i_quest0 + 1;
if (myself.i_quest0 == 1) {
if (c1.is_pc == 1) {
myself.Say(gg.MakeFString(9366, c1.name, "", "", "", ""));

}

}
if (myself.i_quest0 > 15) {
myself.SetMemoState(c1, 93, 14);
if (c1.is_pc == 1) {
myself.Say(gg.MakeFString(9367, c1.name, "", "", "", ""));
...
if (c0) {
myself.AddAttackDesire(c0, 1, 100000);
myself.Say(gg.MakeFString(9364, "", "", "", "", ""));
...
myself.Say(gg.MakeFString(9365, "", "", "", "", ""));
c0 = myself.Maker_FindNpcByKey(myself.sm.param3);
npc0 = gg.GetNPCFromID(c0.id);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 2;
