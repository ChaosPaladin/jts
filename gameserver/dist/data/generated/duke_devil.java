...
public class duke_devil extends raid_duke_devil {
...
target = last_attacker;
if (gg.HaveMemo(target, 132) == 1 && myself.GetOneTimeQuestFlag(target, 132) == 0 && gg.GetMemoState(target, 132) == 1 && gg.OwnItemCount(target, 9801) == 0) {
...
switch (code_info.code) {
case 1: {
myself.SetCurrentQuestID(132);
while (gg.IsNull(target = code_info.Next()) == 0) {
if (myself.DistFromMe(target) <= 1500) {
myself.SetCurrentQuestID(132);
if (gg.OwnItemCount(target, 9800) == 0) {
myself.GiveItem1(target, 9801, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else if (gg.OwnItemCount(target, 9800) >= 1) {
myself.GiveItem1(target, 9801, 1);
myself.SetFlagJournal(target, 132, 2);
myself.ShowQuestMark(target, 132);
