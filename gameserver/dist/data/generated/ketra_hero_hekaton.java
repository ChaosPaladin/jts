...
public class ketra_hero_hekaton extends raid_boss_type3 {
...
target = last_attacker;
if (gg.HaveMemo(target, 613) == 1 && gg.GetMemoState(target, 613) == 1 * 10 + 1) {
...
i4 = gg.Rand(1000);
if (i4 < 1000) {
if (gg.OwnItemCount(target, 7240) + 1 >= 1) {
if (gg.OwnItemCount(target, 7240) < 1) {
myself.GiveItem1(target, 7240, 1 - gg.OwnItemCount(target, 7240));
myself.SoundEffect(target, "ItemSound.quest_middle");
myself.SetFlagJournal(target, 613, 2);
myself.ShowQuestMark(target, 613);
myself.SetMemoState(target, 613, 1 * 10 + 2);

}

} else {
myself.GiveItem1(target, 7240, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
