...
if (gg.HaveMemo(target, 414) == 1 && gg.GetMemoState(target, 414) == 3 && gg.OwnItemCount(target, 8544) == 0) {
...
i0 = gg.Rand(100);
if (i0 < 60) {
myself.GiveItem1(target, 8544, 1);
myself.SetFlagJournal(target, 414, 7);
myself.ShowQuestMark(target, 414);
