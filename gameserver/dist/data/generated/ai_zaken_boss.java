...
public class ai_zaken_boss extends default_npc {
...
myself.CreateOnePrivateEx(1029026, "pirates_zombie_captain_b", 0, 1, i0, i1, i2, gg.Rand(360), 0, 0, 0);
myself.CreateOnePrivateEx(1029026, "pirates_zombie_captain_b", 0, 1, i0, i1, i2, gg.Rand(360), 0, 0, 0);
myself.CreateOnePrivateEx(1029024, "vale_master_b", 0, 1, i0, i1, i2, gg.Rand(360), 0, 0, 0);
myself.CreateOnePrivateEx(1029024, "vale_master_b", 0, 1, i0, i1, i2, gg.Rand(360), 0, 0, 0);
...
if (i5 <= 5 * 60) {
myself.IncrementParam(c1, 0, 1046865);
myself.IncrementParam(c1, 1, 50000);

} else if (i5 <= 10 * 60) {
if (gg.Rand(100) < 20) {
myself.IncrementParam(c1, 0, 837492 + gg.Rand(1000));
myself.IncrementParam(c1, 1, 30000);
