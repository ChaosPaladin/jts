...
public class custodian extends citizen {
	protected String ShopName = "";
	protected String fnHi = "black001.htm";
	protected String fnNotMyLord = "black002.htm";
	protected String fnGetOut = "black003.htm";
	protected String fnOptionList = "black005.htm";
	protected String fnAlreadyHaveOption = "black009.htm";
	protected String fnNeedLowGrade = "black011.htm";
	protected String fnAfterOptionAdd = "black012.htm";
	protected String fnAddHPRegen1 = "black013.htm";
	protected String fnAddHPRegen2 = "black014.htm";
	protected String fnAddMPRegen1 = "black015.htm";
	protected String fnAddMPRegen2 = "black016.htm";
	protected String fnAddTeleporter1 = "black017.htm";
	protected String fnAddTeleporter2 = "black020.htm";
	protected String fnMyPledge = "black019.htm";
	protected String fnTeleportLevelZero = "black021.htm";
	protected String fnWarehouse = "agitwarehouse.htm";
	protected String fnFunction = "agitfunction.htm";
	protected String fnManage = "agitdecomanage.htm";
	protected String fnManageRegen = "agitdeco_ar01.htm";
	protected String fnManageEtc = "agitdeco_ae01.htm";
	protected String fnManageDeco = "agitdeco_ad01.htm";
	protected String fnBanish = "agitbanish.htm";
	protected String fnAfterBanish = "agitafterbanish.htm";
	protected String fnDoor = "agitdoor.htm";
	protected String fnAfterDoorOpen = "agitafterdooropen.htm";
	protected String fnAfterDoorClose = "agitafterdoorclose.htm";
	...
	protected String fnNotEnoughAdena = "agitnotenoughadena.htm";
	protected String fnUnableToSell = "agitunabletosell.htm";
	...
	protected String fnCostFail = "agitcostfail.htm";
...
i0 = 286130177 + myself.Agit_GetDecoLevel(decotype_buff) * 256 * 256;
...
if (myself.Agit_GetCostFailDay() == 0) {
myself.ShowPage(talker, fnHi);

} else {
myself.FHTML_SetFileName(fhtml0, fnCostFail);
myself.FHTML_SetInt(fhtml0, "CostFailDayLeft", 8 - myself.Agit_GetCostFailDay());
...
case 2: {
if (myself.IsMyLord(talker) || myself.HavePledgePower(talker, 14) && myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
...
case 3: {
if (myself.IsMyLord(talker) || myself.HavePledgePower(talker, 12) && myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
...
myself.FHTML_SetInt(fhtml0, "HPDepth", myself.Agit_GetDecoLevel(decotype_hpregen) * 20);
...
myself.FHTML_SetInt(fhtml0, "MPDepth", myself.Agit_GetDecoLevel(decotype_mpregen) * 5);
...
myself.FHTML_SetInt(fhtml0, "XPDepth", myself.Agit_GetDecoLevel(decotype_xprestore) * 5);
...
case 4: {
if (myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
myself.AuctionAgit_GetAgitCostInfo(talker);
...
case 5: {
if (myself.IsMyLord(talker) || myself.HavePledgePower(talker, 15) && myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
...
case 7: {
if (myself.HavePledgePower(talker, 12) && myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
if (myself.Agit_GetDecoLevel(decotype_buff) == 0) {
myself.ShowPage(talker, fnFuncDisabled);

} else {
myself.FHTML_SetFileName(fhtml0, fnAgitBuff + "_" + gg.IntToStr(myself.Agit_GetDecoLevel(decotype_buff)) + ".htm");
...
switch (myself.Agit_GetDecoLevel(decotype_item)) {
case 1: {
...
myself.FHTML_SetStr(fhtml0, "HP" + "Depth", gg.MakeFString(fstr_percent, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_hpregen) * 20), "", "", "", ""));
...
myself.FHTML_SetStr(fhtml0, "MP" + "Depth", gg.MakeFString(fstr_percent, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_mpregen) * 5), "", "", "", ""));
...
myself.FHTML_SetStr(fhtml0, "XP" + "Depth", gg.MakeFString(fstr_percent, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_xprestore) * 5), "", "", "", ""));
...
myself.FHTML_SetStr(fhtml0, "TP" + "Depth", gg.MakeFString(fstr_stage_lv, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_teleport) * 1), "", "", "", ""));
...
myself.FHTML_SetStr(fhtml0, "BC" + "Depth", gg.MakeFString(fstr_stage_lv, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_broadcast) * 1), "", "", "", ""));
...
myself.FHTML_SetStr(fhtml0, "IC" + "Depth", gg.MakeFString(fstr_stage_lv, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_item) * 1), "", "", "", ""));
...
myself.FHTML_SetStr(fhtml0, "BF" + "Depth", gg.MakeFString(fstr_stage_lv, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_buff) * 1), "", "", "", ""));
...
case 53: {
if (myself.IsMyLord(talker) || myself.HavePledgePower(talker, 15) && myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
myself.FHTML_SetFileName(fhtml0, fnManageDeco);
if (myself.Agit_GetDecoLevel(decotype_curtain) == 0) {
myself.FHTML_SetStr(fhtml0, "7_" + "Depth", gg.MakeFString(4, "", "", "", "", ""));
myself.FHTML_SetStr(fhtml0, "7_" + "Expire", gg.MakeFString(4, "", "", "", "", ""));
myself.FHTML_SetStr(fhtml0, "7_" + "Reset", "");

} else {
myself.FHTML_SetStr(fhtml0, "7_" + "Depth", gg.MakeFString(fstr_stage_lv, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_curtain) * 1), "", "", "", ""));
myself.FHTML_SetStr(fhtml0, "7_" + "Cost", "(" + gg.MakeFString(6, gg.IntToStr(myself.Agit_GetDecoFee(decotype_curtain, myself.Agit_GetDecoLevel(decotype_curtain))), gg.IntToStr(myself.Agit_GetDecoDay(decotype_curtain, myself.Agit_GetDecoLevel(decotype_curtain))), "", "", "") + ")");
myself.FHTML_SetStr(fhtml0, "7_" + "Expire", gg.MakeFString(5, gg.IntToStr(gg.GetDateTime(myself.Agit_GetDecoExpire(decotype_curtain), 1)), gg.IntToStr(gg.GetDateTime(myself.Agit_GetDecoExpire(decotype_curtain), 2)), gg.IntToStr(gg.GetDateTime(myself.Agit_GetDecoExpire(decotype_curtain), 3)), "", ""));
myself.FHTML_SetStr(fhtml0, "7_" + "Reset", gg.MakeFString(7, fnBracketL, gg.IntToStr(decotype_curtain), fnBracketR, "", ""));

}
if (myself.Agit_GetDecoLevel(decotype_platform) == 0) {
myself.FHTML_SetStr(fhtml0, "11_" + "Depth", gg.MakeFString(4, "", "", "", "", ""));
myself.FHTML_SetStr(fhtml0, "11_" + "Expire", gg.MakeFString(4, "", "", "", "", ""));
myself.FHTML_SetStr(fhtml0, "11_" + "Reset", "");

} else {
myself.FHTML_SetStr(fhtml0, "11_" + "Depth", gg.MakeFString(fstr_stage_lv, gg.IntToStr(myself.Agit_GetDecoLevel(decotype_platform) * 1), "", "", "", ""));
myself.FHTML_SetStr(fhtml0, "11_" + "Cost", "(" + gg.MakeFString(6, gg.IntToStr(myself.Agit_GetDecoFee(decotype_platform, myself.Agit_GetDecoLevel(decotype_platform))), gg.IntToStr(myself.Agit_GetDecoDay(decotype_platform, myself.Agit_GetDecoLevel(decotype_platform))), "", "", "") + ")");
myself.FHTML_SetStr(fhtml0, "11_" + "Expire", gg.MakeFString(5, gg.IntToStr(gg.GetDateTime(myself.Agit_GetDecoExpire(decotype_platform), 1)), gg.IntToStr(gg.GetDateTime(myself.Agit_GetDecoExpire(decotype_platform), 2)), gg.IntToStr(gg.GetDateTime(myself.Agit_GetDecoExpire(decotype_platform), 3)), "", ""));
myself.FHTML_SetStr(fhtml0, "11_" + "Reset", gg.MakeFString(7, fnBracketL, gg.IntToStr(decotype_platform), fnBracketR, "", ""));
...
myself.FHTML_SetFileName(fhtml0, "agitdeco__" + gg.IntToStr(i0) + ".htm");
...
myself.FHTML_SetStr(fhtml0, "AgitDecoEffect", gg.MakeFString(fstr_percent, gg.IntToStr(i1 * 20), "", "", "", ""));

} else if (i0 == decotype_mpregen) {
myself.FHTML_SetStr(fhtml0, "AgitDecoEffect", gg.MakeFString(fstr_percent, gg.IntToStr(i1 * 5), "", "", "", ""));
...
myself.FHTML_SetStr(fhtml0, "AgitDecoEffect", gg.MakeFString(fstr_stage_lv, gg.IntToStr(i1), "", "", "", ""));
...
if (myself.IsMyLord(talker) || myself.HavePledgePower(talker, 11) && myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
if (myself.Agit_GetDecoLevel(decotype_teleport) == 1) {
myself.Teleport(talker, Position1, ShopName, "", "", "", 57, "");

} else if (myself.Agit_GetDecoLevel(decotype_teleport) == 2) {
...
myself.ShowPage(talker, fnNoAuthority);
	...
	protected void AUCTION_AGIT_GET_COST_INFO_RETURNED(HandlerParam talker, HandlerParam reply, HandlerParam s0, HandlerParam fhtml0) {
if (myself.Castle_GetPledgeId() == talker.pledge_id && talker.pledge_id != 0) {
myself.FHTML_SetFileName(fhtml0, fnWarehouse);
myself.FHTML_SetInt(fhtml0, "agit_lease", reply);
myself.FHTML_SetStr(fhtml0, "pay_time", s0);
myself.ShowFHTML(talker, fhtml0);
