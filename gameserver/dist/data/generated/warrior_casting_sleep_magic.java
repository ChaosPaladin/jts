...
if (myself.top_desire_target != attacker && i6 < 30 && myself.sm.hp > myself.sm.max_hp / 10.000000) {
...
if (gg.GetAbnormalLevel(myself.top_desire_target, myself.Skill_GetAbnormalType(SleepMagic)) <= 0) {
if (myself.Skill_GetConsumeMP(SleepMagic) < myself.sm.mp && myself.Skill_GetConsumeHP(SleepMagic) < myself.sm.hp && myself.Skill_InReuseDelay(SleepMagic) == 0) {
myself.AddUseSkillDesire(myself.top_desire_target, SleepMagic, 0, 1, 1000000);
