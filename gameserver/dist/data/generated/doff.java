...
public class doff extends citizen {
...
_choiceN = _choiceN + 1;
_code = 0;
myself.AddChoice(0, "Mystic's Tutorial");
...
_choiceN = _choiceN + 1;
_code = 3;
myself.AddChoice(3, "Mystic's Tutorial (In Progress)");

}
if (gg.GetMemoStateEx(talker, 255, 1) > 3) {
_choiceN = _choiceN + 1;
_code = 4;
myself.AddChoice(4, "Mystic's Tutorial (In Progress)");
...
if (talker.occupation == 10 && talker.race == 0) {
myself.DeleteRadar(talker, -91036, 248044, -3568, 2);
...
myself.ShowPage(talker, "doff004.htm");
...
myself.VoiceEffect(talker, "tutorial_voice_010b", 0);
