...
public class agit_wizard_flee extends agit_warrior_flee {
...
if (gg.Rand(100) < 10) {
if (myself.Skill_GetConsumeMP(266403846) < myself.sm.mp && myself.Skill_GetConsumeHP(266403846) < myself.sm.hp && myself.Skill_InReuseDelay(266403846) == 0) {
myself.AddUseSkillDesire(myself.sm, 266403846, 1, 1, 1000000);
