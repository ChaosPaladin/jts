...
target = last_attacker;
if (gg.HaveMemo(target, 348) && gg.GetMemoStateEx(target, 348, 0) == 12 || gg.GetMemoStateEx(target, 348, 0) == 13 && gg.OwnItemCount(target, 4294) > 0) {
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(1000) < 451) {
myself.GiveItem1(target, 5967, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(1000) < 115) {
myself.GiveItem1(target, 7586, 7);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else {
myself.GiveItem1(target, 7586, 6);
myself.SoundEffect(target, "ItemSound.quest_itemget");
...
target = code_info.RandomSelectOne();
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.HaveMemo(target, 348) && gg.GetMemoStateEx(target, 348, 0) == 12 && gg.OwnItemCount(target, 4294) > 0) {
target.quest_last_reward_time = myself.GetCurrentTick();
i0 = gg.GetMemoStateEx(target, 348, 1);
i0 = i0 + 700;
myself.SetMemoStateEx(target, 348, 1, i0);
if (gg.GetMemoStateEx(target, 348, 1) + 700 > 80000) {
myself.GiveItem1(target, 4295, 1);
myself.DeleteItem1(target, 4294, 1);
myself.RemoveMemo(target, 348);
gg.AddLog(3, target, 348);
myself.SoundEffect(target, "ItemSound.quest_finish");

}

}
if (gg.HaveMemo(target, 348) && gg.GetMemoStateEx(target, 348, 0) == 13 && gg.OwnItemCount(target, 4294) > 0) {
target.quest_last_reward_time = myself.GetCurrentTick();
i0 = gg.GetMemoStateEx(target, 348, 1);
i0 = i0 + 700;
myself.SetMemoStateEx(target, 348, 1, i0);
if (gg.GetMemoStateEx(target, 348, 1) + 700 > 100000) {
myself.GiveItem1(target, 4295, 1);
myself.DeleteItem1(target, 4294, 1);
myself.SetMemoStateEx(target, 348, 0, 14);
myself.SoundEffect(target, "ItemSound.quest_middle");
...
super;
	...
	protected void ATTACKED(HandlerParam attacker, HandlerParam c0, HandlerParam c1, HandlerParam c2, HandlerParam damage, HandlerParam i0, HandlerParam i1, HandlerParam i2, HandlerParam i3, HandlerParam skill_name_id) {
myself.SetCurrentQuestID(350);
...
i2 = 0;
if (i1 == 0) {
if (gg.HaveMemo(c1, 348) && gg.GetMemoStateEx(c1, 348, 0) == 12 || gg.GetMemoStateEx(c1, 348, 0) == 13 && gg.OwnItemCount(c1, 4294) > 0) {
c2 = c1;
...
if (gg.HaveMemo(c0, 348) && gg.GetMemoStateEx(c0, 348, 0) == 12 || gg.GetMemoStateEx(c0, 348, 0) == 13 && gg.OwnItemCount(c0, 4294) > 0) {
i3 = gg.Rand(1000);
if (i2 <= i3) {
i2 = i3;
c2 = c0;
...
if (gg.HaveMemo(c2, 348) && gg.GetMemoStateEx(c2, 348, 0) == 12 && gg.OwnItemCount(c2, 4294) > 0) {
...
if (gg.GetMemoStateEx(c2, 348, 1) + 70 > 80000) {
myself.GiveItem1(c2, 4295, 1);
myself.DeleteItem1(c2, 4294, 1);
myself.RemoveMemo(c2, 348);
gg.AddLog(3, c2, 348);
...
if (gg.HaveMemo(c2, 348) && gg.GetMemoStateEx(c2, 348, 0) == 13 && gg.OwnItemCount(c2, 4294) > 0) {
if (myself.GetCurrentTick() - c2.quest_last_reward_time > 1) {
c2.quest_last_reward_time = myself.GetCurrentTick();
i0 = gg.GetMemoStateEx(c2, 348, 1);
i0 = i0 + 70;
myself.SetMemoStateEx(c2, 348, 1, i0);
if (gg.GetMemoStateEx(c2, 348, 1) + 70 > 100000) {
myself.GiveItem1(c2, 4295, 1);
myself.DeleteItem1(c2, 4294, 1);
myself.SetMemoStateEx(c2, 348, 0, 14);
