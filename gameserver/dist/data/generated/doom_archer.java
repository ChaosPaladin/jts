...
target = last_attacker;
if (gg.HaveMemo(target, 359) == 1 && gg.GetMemoState(target, 359) == 1 && gg.OwnItemCount(target, 5869) < 60) {
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(1000) < 503) {
myself.GiveItem1(target, 5869, 1);
if (gg.OwnItemCount(target, 5869) >= 59) {
myself.SetFlagJournal(target, 359, 2);
myself.ShowQuestMark(target, 359);
