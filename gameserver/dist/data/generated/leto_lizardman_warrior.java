...
target = last_attacker;
if (gg.HaveMemo(target, 420) == 1 && gg.OwnItemCount(target, 3822) == 1 && gg.OwnItemCount(target, 3823) < 20) {
...
if (gg.HaveMemo(c1, 213) && gg.OwnItemCount(c1, 2667) == 1 && gg.OwnItemCount(c1, 2671) == 0) {
if (gg.Rand(100) < 100) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2671, 1);
myself.SoundEffect(c1, "ItemSound.quest_middle");
if (gg.OwnItemCount(c1, 2668) >= 1 && gg.OwnItemCount(c1, 2669) >= 1 && gg.OwnItemCount(c1, 2670) >= 1) {
...
if (gg.HaveMemo(c1, 214) && gg.OwnItemCount(c1, 2675) == 1 && gg.OwnItemCount(c1, 2689) == 1 && gg.OwnItemCount(c1, 2686) == 1 && gg.OwnItemCount(c1, 2687) < 5) {
if (gg.Rand(100) < 100) {
c1.quest_last_reward_time = myself.GetCurrentTick();
myself.GiveItem1(c1, 2687, 1);
if (gg.OwnItemCount(c1, 2687) >= 4) {
myself.SetFlagJournal(c1, 214, 12);
...
myself.GiveItem1(target, 3823, 1);
if (gg.OwnItemCount(target, 3823) >= 19) {
...
myself.Say(gg.MakeFString(42049, "", "", "", "", ""));
...
target = code_info.RandomSelectOne();
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(100) < 88 && gg.OwnItemCount(target, 10367) < 1) {
