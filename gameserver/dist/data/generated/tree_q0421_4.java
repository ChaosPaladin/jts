...
public class tree_q0421_4 extends quest_party_leader {
...
if (gg.GetMemoState(c1, 421) % 16 < 8) {
if (attacker.pet_dbid == gg.GetMemoStateEx(c1, 421, 1)) {
c1.flag = c1.flag + 1;
if (c1.flag < 270) {
if (gg.Rand(100) <= 1) {
myself.AddUseSkillDesire(c1, 78708769, 0, 0, 1000000);
...
myself.SetMemoState(c1, 421, gg.GetMemoState(c1, 421) + 8);
...
myself.Say(gg.MakeFString(42117, "", "", "", "", ""));
