...
public class mouth_of_saruhi_mudaha extends lv3_orc {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 78) == 1 && target.occupation == 52 && gg.GetMemoState(target, 78) == 7 && gg.OwnItemCount(target, 7338) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(7852, "", "", "", "", ""));
myself.GiveItem1(target, 7338, 1);
myself.SetFlagJournal(target, 78, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(7850, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(7851, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
