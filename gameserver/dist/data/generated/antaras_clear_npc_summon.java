...
public class antaras_clear_npc_summon extends default_npc {
...
if (timer_id == 1001) {
myself.BroadcastScriptEventEx(12006, myself.i_ai0, myself.i_ai1, 100);
myself.BroadcastScriptEventEx(12009, myself.i_ai1, 0, 100);
myself.Despawn();
