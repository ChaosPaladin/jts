...
public class fallenangel_haures_1 extends lv3_healer {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 87) == 1 && target.occupation == 30 && gg.GetMemoState(target, 87) == 7 && gg.OwnItemCount(target, 7347) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8752, "", "", "", "", ""));
myself.GiveItem1(target, 7347, 1);
myself.SetFlagJournal(target, 87, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8750, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8751, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
