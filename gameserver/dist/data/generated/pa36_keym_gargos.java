...
public class pa36_keym_gargos extends ai_keym_trapopen {
...
if (gg.HaveMemo(target, 128) == 1 && gg.GetMemoState(target, 128) == 7 && myself.GetOneTimeQuestFlag(target, 128) == 0) {
...
myself.GiveItem1(target, 13136, 1);
myself.DeleteItem1(target, 13135, gg.OwnItemCount(target, 13135));
myself.SetMemoState(target, 128, 8);
myself.SetFlagJournal(target, 128, 8);
