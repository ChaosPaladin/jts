...
public class kein_flying_knife extends citizen {
	protected void TALK_SELECTED(HandlerParam talker) {
if (_from_choice == 0) {
if (gg.HaveMemo(talker, 226) == 1 && gg.GetMemoState(talker, 226) == 8 && gg.OwnItemCount(talker, 2816) && gg.OwnItemCount(talker, 2819) == 0) {
_choiceN = _choiceN + 1;
_code = 0;
...
switch (_code) {
case 0: {
if (_from_choice == 0 || gg.HaveMemo(talker, 226) == 1 && gg.GetMemoState(talker, 226) == 8 && gg.OwnItemCount(talker, 2816) && gg.OwnItemCount(talker, 2819) == 0) {
...
myself.ShowPage(talker, "kein_flying_knife_q0226_01.htm");
...
myself.ShowPage(talker, "kein_flying_knife_q0226_02.htm");
...
myself.ShowPage(talker, "kein_flying_knife_q0226_03.htm");
