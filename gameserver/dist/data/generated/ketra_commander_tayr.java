...
public class ketra_commander_tayr extends raid_boss_type5 {
...
target = last_attacker;
if (gg.HaveMemo(target, 614) == 1 && gg.GetMemoState(target, 614) == 1 * 10 + 1) {
...
i4 = gg.Rand(1000);
if (i4 < 1000) {
if (gg.OwnItemCount(target, 7241) + 1 >= 1) {
if (gg.OwnItemCount(target, 7241) < 1) {
myself.GiveItem1(target, 7241, 1 - gg.OwnItemCount(target, 7241));
myself.SoundEffect(target, "ItemSound.quest_middle");
myself.SetFlagJournal(target, 614, 2);
myself.ShowQuestMark(target, 614);
myself.SetMemoState(target, 614, 1 * 10 + 2);

}

} else {
myself.GiveItem1(target, 7241, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
