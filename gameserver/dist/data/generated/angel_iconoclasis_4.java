...
public class angel_iconoclasis_4 extends lv3_dwarf {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 99) == 1 && target.occupation == 55 && gg.GetMemoState(target, 99) == 7 && gg.OwnItemCount(target, 7359) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9952, "", "", "", "", ""));
myself.GiveItem1(target, 7359, 1);
myself.SetFlagJournal(target, 99, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9950, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9951, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
