...
if (gg.HaveMemo(myself.c_quest0, 409) == 1 && gg.OwnItemCount(myself.c_quest0, 1234) == 0 && myself.i_quest0 == 1) {
myself.Say(gg.MakeFString(40910, "", "", "", "", ""));
myself.GiveItem1(myself.c_quest0, 1234, 1);
myself.SetFlagJournal(myself.c_quest0, 409, 3);
myself.ShowQuestMark(myself.c_quest0, 409);
...
myself.SetCurrentQuestID(409);
if (gg.HaveMemo(attacker, 409)) {
switch (myself.i_quest0) {
case 0: {
myself.Say(gg.MakeFString(40909, "", "", "", "", ""));
myself.i_quest0 = 1;
if (attacker.master) {
