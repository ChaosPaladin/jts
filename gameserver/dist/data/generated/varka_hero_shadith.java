...
public class varka_hero_shadith extends raid_boss_type4 {
...
target = last_attacker;
if (gg.HaveMemo(target, 607) == 1 && gg.GetMemoState(target, 607) == 1 * 10 + 1) {
...
i4 = gg.Rand(1000);
if (i4 < 1000) {
if (gg.OwnItemCount(target, 7235) + 1 >= 1) {
if (gg.OwnItemCount(target, 7235) < 1) {
myself.GiveItem1(target, 7235, 1 - gg.OwnItemCount(target, 7235));
myself.SoundEffect(target, "ItemSound.quest_middle");
myself.SetFlagJournal(target, 607, 2);
myself.ShowQuestMark(target, 607);
myself.SetMemoState(target, 607, 1 * 10 + 2);

}

} else {
myself.GiveItem1(target, 7235, 1);
myself.SoundEffect(target, "ItemSound.quest_itemget");
