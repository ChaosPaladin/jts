...
public class dawn_acolyte4 extends ssq_main_event_acolyte {
...
myself.FHTML_SetFileName(fhtml0, "ssq_main_event_acolyte_q0505_04d.htm");
myself.FHTML_SetStr(fhtml0, "name", c1.name);
myself.ShowFHTML(talker, fhtml0);
myself.RemoveMemo(talker, 505);
return;

} else if (c1.max_magic_level > 64) {
...
if (gg.GetMemoStateEx(talker, 505, 1) == 4500) {
if (gg.OwnItemCount(talker, 6360) < 4500) {
...
if (gg.GetMemoStateEx(talker, 505, 1) == 2700) {
if (gg.OwnItemCount(talker, 6361) < 2700) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_21a.htm");
return;
...
if (gg.GetMemoStateEx(talker, 505, 1) == 1350) {
if (gg.OwnItemCount(talker, 6362) < 1350) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_21a.htm");
return;
...
if (gg.AddPartyToEventRoom(4, 2, party0.id)) {
...
myself.DeleteItem1(talker, 6360, 4500);
...
myself.DeleteItem1(talker, 6361, 2700);
...
myself.DeleteItem1(talker, 6362, 1350);
...
myself.SetMemoStateEx(talker, 505, 1, 4);
gg.AddPartyToEventRoom(4, 2, party0.id);
...
myself.AddTimeAttackFee(4, 13500, party0.id);
...
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_20i.htm");
...
} else if (gg.GetMemoStateEx(talker, 505, 1) != 4) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_28.htm");

} else if (gg.StrToInt(gg.GetTimeAttackRecordInfo(4, 2, 4, 0)) > gg.OwnItemCount(talker, 5901)) {
i1 = gg.Party_GetCount(talker);
for (i0 = 0; i0 < i1; i0 = i0 + 1) {
c1 = gg.Party_GetCreature(talker, i0);
...
myself.Shout(gg.MakeFString(50503, talker.name, gg.IntToStr(65), gg.IntToStr(i2), "", ""));
...
myself.RemoveMemo(talker, 505);
myself.AddTimeAttackRecord(4, 2, party0.id, gg.OwnItemCount(talker, 5901), gg.GetTimeOfDay(), gg.GetMemoState(talker, 505));
...
if (gg.IsWinnerOfTimeAttackEvent(talker, 4) == 0) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_17.htm");
return;

}
if (gg.GetTimeAttackRewardFlag(talker, 4)) {
myself.ShowPage(talker, "ssq_main_event_acolyte_q0505_19.htm");
return;

}
i0 = gg.StrToInt(gg.GetTimeAttackRecordInfo(4, gg.GetSSQPart(talker), 2, 0));
i1 = myself.GetTimeAttackFee(4) / i0;
myself.GiveTimeAttackReward(talker, 4, 5575, i1);
...
myself.SetMemoStateEx(talker, 505, 1, 4500);
...
myself.SetMemoStateEx(talker, 505, 1, 2700);
myself.FHTML_SetFileName(fhtml0, "ssq_main_event_acolyte_q0505_06.htm");
myself.FHTML_SetInt(fhtml0, "quest_id", 505);
myself.ShowFHTML(talker, fhtml0);
...
myself.SetMemoStateEx(talker, 505, 1, 1350);
myself.FHTML_SetFileName(fhtml0, "ssq_main_event_acolyte_q0505_06.htm");
myself.FHTML_SetInt(fhtml0, "quest_id", 505);
myself.ShowFHTML(talker, fhtml0);
