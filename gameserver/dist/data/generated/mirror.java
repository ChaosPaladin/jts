...
if (gg.HaveMemo(target, 335) && gg.OwnItemCount(target, 3762) && gg.OwnItemCount(target, 3804) < 40) {
...
if (gg.Rand(100) < 96) {
myself.GiveItem1(target, 3804, 1);
if (gg.OwnItemCount(target, 3804) >= 40) {
...
if (gg.OwnItemCount(target, 9787) >= 33) {
...
myself.GiveItem1(target, 9787, 2);
if (i4 < 290 && gg.OwnItemCount(target, 9787) < 33) {
myself.GiveItem1(target, 9787, 1);

}

} else if (gg.OwnItemCount(target, 9787) == 34) {
myself.GiveItem1(target, 9787, 1);
myself.SetFlagJournal(target, 136, 4);
myself.ShowQuestMark(target, 136);
myself.SoundEffect(target, "ItemSound.quest_middle");
