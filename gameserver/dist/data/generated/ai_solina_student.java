...
public class ai_solina_student extends warrior {
	protected int MoveAroundSocial = 0;
	protected int Skill01_ID = 413532161;
...
myself.AddUseSkillDesire(creature, Skill01_ID, 0, 1, 1000000);

}
myself.c_ai0 = creature;
if (myself.i_ai3 == 0) {
myself.AddTimerEx(timer, 20 * 1000);
myself.i_ai3 = 1;
...
if (gg.Rand(100) < 3) {
if (myself.Skill_GetConsumeMP(Skill01_ID) < myself.sm.mp && myself.Skill_GetConsumeHP(Skill01_ID) < myself.sm.hp && myself.Skill_InReuseDelay(Skill01_ID) == 0) {
myself.AddUseSkillDesire(myself.c_ai1, Skill01_ID, 0, 1, 1000000);
