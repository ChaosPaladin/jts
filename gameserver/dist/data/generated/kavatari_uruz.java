...
public class kavatari_uruz extends lv3_ranger {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 76) == 1 && target.occupation == 48 && gg.GetMemoState(target, 76) == 7 && gg.OwnItemCount(target, 7336) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(7652, "", "", "", "", ""));
myself.GiveItem1(target, 7336, 1);
myself.SetFlagJournal(target, 76, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(7650, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(7651, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
