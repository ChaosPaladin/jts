...
public class ai_anakims_divine_ssq extends default_npc {
...
i0 = gg.Rand(100);
if (i0 < 20) {
myself.AddUseSkillDesire(attacker, 405929985, 0, 1, 1000000);
...
if (timer_id = 1000) {
myself.BroadcastScriptEvent(9274215, myself.sm.id, 3000);
