...
if (gg.OwnItemCount(target, 9773) >= 28) {
...
myself.GiveItem1(target, 9773, 2);
if (gg.Rand(1000) < 220 && gg.OwnItemCount(target, 9773) < 28) {
myself.GiveItem1(target, 9773, 1);
if (gg.OwnItemCount(target, 9773) >= 27) {
myself.SetFlagJournal(target, 66, 4);
myself.ShowQuestMark(target, 66);
myself.SoundEffect(target, "ItemSound.quest_middle");
i4 = 1;
...
if (gg.IsNull(target) == 0 && myself.DistFromMe(target) <= 1500) {
if (gg.Rand(100) < 33) {
myself.GiveItem1(target, 8076, 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");
