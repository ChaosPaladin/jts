...
public class dark_ballerina_lilian extends lv3_song_dance {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 96) == 1 && target.occupation == 34 && gg.GetMemoState(target, 96) == 7 && gg.OwnItemCount(target, 7356) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9652, "", "", "", "", ""));
myself.GiveItem1(target, 7356, 1);
myself.SetFlagJournal(target, 96, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9650, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9651, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
