...
public class fallenangel_allector_1 extends lv3_wizard {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 88) == 1 && target.occupation == 12 && gg.GetMemoState(target, 88) == 7 && gg.OwnItemCount(target, 7348) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(8852, "", "", "", "", ""));
myself.GiveItem1(target, 7348, 1);
myself.SetFlagJournal(target, 88, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(8850, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(8851, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
