...
public class spc_soulwagon_2lv_d extends ai_immo_basic {
...
myself.SetCurrentQuestID(698);
if (myself.DistFromMe(target) <= 1500) {
myself.SetMemoStateEx(target, 698, 1, gg.GetMemoStateEx(target, 698, 1) + 1);
...
i0 = gg.Rand(1000);
if (i0 < 477) {
myself.GiveItem1(target, 13863, gg.Rand(4) + 1 * 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");

} else {
myself.GiveItem1(target, 13863, gg.Rand(6) + 5 * 2);
myself.SoundEffect(target, "ItemSound.quest_itemget");
