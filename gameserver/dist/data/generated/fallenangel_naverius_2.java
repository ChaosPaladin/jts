...
public class fallenangel_naverius_2 extends lv3_song_dance {
...
if (target.is_pc == 1) {
if (gg.HaveMemo(target, 98) == 1 && target.occupation == 43 && gg.GetMemoState(target, 98) == 7 && gg.OwnItemCount(target, 7358) == 0 && target.dbid == myself.sm.param2) {
myself.Say(gg.MakeFString(9852, "", "", "", "", ""));
myself.GiveItem1(target, 7358, 1);
myself.SetFlagJournal(target, 98, 9);
...
if (c0) {
if (c0.is_pc == 1) {
myself.Say(gg.MakeFString(9850, c0.name, "", "", "", ""));
...
myself.Say(gg.MakeFString(9851, "", "", "", "", ""));
npc0 = gg.GetNPCFromID(myself.sm.param3);
if (gg.IsNull(npc0) == 0) {
npc0.i_quest0 = 0;
