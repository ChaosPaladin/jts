...
public class event_jackpot_bug extends warrior_basic {
...
if (script_event_arg1 == 7777777) {
myself.i_ai4 = gg.Rand(RandRate);
if (script_event_arg2 == myself.i_ai4) {
myself.SetVisible(1);
myself.i_ai3 = 1;
...
myself.Say(gg.MakeFString(1800291, "", "", "", "", ""));
