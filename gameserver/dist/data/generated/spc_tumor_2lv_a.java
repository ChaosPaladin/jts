...
public class spc_tumor_2lv_a extends ai_immo_tumor {
...
if (gg.HaveMemo(target, 697) == 1 && gg.GetMemoState(target, 697) == 2) {
...
case 0: {
myself.SetCurrentQuestID(697);
while (gg.IsNull(target = code_info.Next()) == 0) {
if (myself.DistFromMe(target) <= 1500) {
myself.SetCurrentQuestID(697);
if (myself.DistFromMe(target) <= 1500) {
myself.SetMemoStateEx(target, 697, 1, gg.GetMemoStateEx(target, 697, 1) + 1);
