...
package ru.jts.data.holder.itemdata;
...
import ru.jts.data.holder.itemdata.item.ec_cond.DefaultEquipCond;
import ru.jts.data.holder.itemdata.item.use_cond.DefaultUseCond;

import static ru.jts.data.holder.ItemDataHolder.UseCondObjectFactory;
...
public class ItemData {
    ...
    @EnumValue
    public ItemAction default_action; // Действие, выполняемое при двойном щелчке по предмету
    ...
    public int mp_bonus;
    @IntArray(canBeNull = true)
    public int[] category = ArrayUtils.EMPTY_INT_ARRAY; // Неизвестно, всегда пустой
    @IntValue
    ...
    public static enum ItemEquipOption {
        no_attack, only_use_weapon_skill, force_equip
    }
    ...
    public static enum DefendAttribute {
        none, fire, water, wind, earth, holy, unholy
    }

    public static enum CrystalType {
        none, d, c, b, a, s, s80, s84, crystal_free, event
    }

    public static enum MaterialType {
        steel, fine_steel, wood, bone, bronze, leather, cloth, fish, gold, mithril, liquid, oriharukon, damascus,
        adamantaite, blood_steel, paper, silver, chrysolite, crystal, horn, scale_of_dragon, cotton, dyestuff,
    ...
    public static enum ItemAction {
        action_none, action_equip, action_peel, action_skill_reduce, action_soulshot, action_spiritshot,
        action_recipe, action_skill_maintain, action_dice, action_calc, action_seed, action_harvest,
    ...
    public static enum ItemType {
        weapon, armor, etcitem, asset, accessary, questitem
    }

    public static enum WeaponType {
        none, sword, blunt, dagger, bow, pole, dual, etc, fist, dualfist, fishingrod,
    ...
    public static enum EtcitemType {
        none, arrow, potion, scrl_enchant_wp, scrl_enchant_am, scroll,
        recipe, material, pet_collar, castle_guard, lotto, race_ticket,
        dye, seed, crop, maturecrop, harvest, seed2, ticket_of_lord, lure,
        bless_scrl_enchant_wp, bless_scrl_enchant_am, coupon, elixir,
        scrl_enchant_attr, bolt, scrl_inc_enchant_prop_wp, scrl_inc_enchant_prop_am,
        ancient_crystal_enchant_wp, ancient_crystal_enchant_am, rune_select, rune
    }
