 ...
 * @author : Camelion
 * @date : 25.08.12  0:09
 * Показывает парсеру, что поле класса должно считываться как элемент типа Double
 * Если поле класса имеет тип List<Double>
 * то этот список будет заполняться элементами типа Double
 */
